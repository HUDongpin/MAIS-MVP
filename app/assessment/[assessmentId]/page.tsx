...
export default function StudentAssessmentPage() {
  ...
  return (
    <div className="page-container py-10 sm:py-12">
      ...
      <form onSubmit={submitAssessment} className="mt-7 grid gap-5">
        {data.questions.map((question, index) => {
          ...
          return (
            <section key={question.id} className="glass-panel p-5 sm:p-6">
              ...
              {previousAnswer ? (
                <p className={`mt-4 text-sm font-black ${previousAnswer.isCorrect ? "text-emerald-700 dark:text-emerald-200" : "text-rose-700 dark:text-rose-200"}`}>
