...
import { getTeacherReportPreview, teacherReportPreviewToCsv } from "@/lib/server/userStore";
...
export async function GET(request: Request) {
  ...
  if (!preview) return NextResponse.json({ error: "Report export unavailable." }, { status: 404 });
