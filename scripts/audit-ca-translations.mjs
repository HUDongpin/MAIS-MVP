...
//
// ENFORCED (build-owned, must stay English-only):
//   ccss-textbook-practice-v1              generated by build-ccss-practice-pack.mjs
//
// REPORTED ONLY (pre-existing Chinese, pending an owner decision — see the pending
// count in the output; flip these to enforced once that decision is made):
...
const PACKS = [
  ...
  { id: "us-ca-k5-knowledge-point-practice-v1", enforced: false },
  { id: "us-ca-math-g6-g12-generated-bank-v2-1500", enforced: false }
];
