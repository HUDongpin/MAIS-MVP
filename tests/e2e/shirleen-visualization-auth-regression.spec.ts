...
test.describe("Shirleen California Visualization Lab auth regression", () => {
  ...
  test("Shirleen stays signed in after saving a California Visualization Lab and the analytics flush", async ({ page }) => {
    ...
    // Exploration records automatically once the lab runtime is ready — there is
    // no "Mark explored" button. Register the listener before navigating.
    ...
    // Earned exploration: interact with the ready lab body so the automatic
    // POST can fire after the engagement dwell.
