...
const allProjectionStates = ["default", "playing", "reset", "terminal-settled"] as const;
const animatedProjectionStates = ["playing", "terminal-settled"] as const;

const functionGraphReviewedContract = {
  cameraShots: [
  ...
  objects: {
    axes: {
      ...
      requiredProjectionStates: allProjectionStates,
      type: "axis3d"
    },
    "function-curve": {
      ...
      requiredProjectionStates: animatedProjectionStates,
...
} as const satisfies ReviewedFamilyContract;

const functionFamilyReviewedContract = {
  cameraShots: [
    { id: "overview", fov: 48, position: [3.4, 2.8, 4.1], target: [0, 0.78, 0] },
  ...
  objects: {
    ...
    "comparison-family-curve": {
      approvedGeometryDigest: "791d31baf4419a27ff283b390430a4dc83f7ec2fe5e8dd4c32b3ff68d8a8b27a",
      colorRole: "trace",
      conceptId: "comparison-rule",
      minimumWorldArcLength: 4.8,
      minimumWorldExtent: 4.5,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "family-probe": {
      colorRole: "probe",
      conceptId: "probe-point",
      pathObjectId: "primary-family-curve",
      requiredProjectionStates: allProjectionStates,
      type: "movingPoint"
    },
    "family-probe-trace": {
      ...
      conceptId: null,
      requiredProjectionStates: ["playing"],
      sourceObjectId: "family-probe",
      type: "trace"
    },
    "primary-family-curve": {
      approvedGeometryDigest: "b5918a2c1cee3f2c5eafd80c7724416a5299ced69aadb6782e59415dafd3b957",
      colorRole: "function",
...
const trigUnitWaveReviewedContract = {
  cameraShots: [
...
const probabilityMachineReviewedContract = {
  cameraShots: [
  ...
  objects: {
    axes: {
      approvedGeometryDigest: "b8c8e7330c00248fade57e0b0462a8c4fda7acab368e085fc97a9d4e03bc8ce0",
      conceptId: "coordinate-frame",
      minimumWorldArcLength: 13,
      minimumWorldExtent: 5.5,
      requiredProjectionStates: allProjectionStates,
      type: "axis3d"
    },
    "expectation-vector": {
      approvedGeometryDigest: "29f0e071d8758447a7fd5b6d475e3b0579a6fbe989f8078c84f26c0c1991bff5",
      colorRole: "probe",
      conceptId: "expected-value",
      minimumWorldArcLength: 1,
      minimumWorldExtent: 1,
      requiredProjectionStates: allProjectionStates,
      type: "vector"
    },
    "experimental-distribution": {
      approvedGeometryDigest: "fbe5a3f09c0fb5233d1b2621ec310429c426174f38b3662d1412901c2192cb1f",
      colorRole: "trace",
      conceptId: "experimental-frequency",
      minimumWorldArcLength: 4,
      minimumWorldExtent: 4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "outcome-probe": {
      ...
      pathObjectId: "trial-stream",
      requiredProjectionStates: allProjectionStates,
      type: "movingPoint"
    },
    "theoretical-distribution": {
      approvedGeometryDigest: "f096ba8bb278eded5b569aa1ecd27f7b30a89a21728f2630612ae2d4b47048ab",
      colorRole: "function",
      conceptId: "probability-model",
      minimumWorldArcLength: 4.1,
      minimumWorldExtent: 4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "trial-stream": {
      approvedGeometryDigest: "a6eb76f7839da172cb299539d20629574b87e06c74628e05049314a4214b0b59",
      colorRole: "probe",
      conceptId: "trial-process",
      minimumWorldArcLength: 2.4,
      minimumWorldExtent: 2.4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "trial-trace": {
      ...
      conceptId: null,
      requiredProjectionStates: ["playing"],
      sourceObjectId: "outcome-probe",
      type: "trace"
    },
    "variability-vector": {
      approvedGeometryDigest: "640962dc817b149f3ec201fc73271056b6a3b396bb8ef94ee4b31d356a7e7877",
      colorRole: "trace",
      conceptId: "experimental-frequency",
      minimumWorldArcLength: 1.5,
      minimumWorldExtent: 1.5,
      requiredProjectionStates: allProjectionStates,
      type: "vector"
    }
  },
...
const statisticalInferenceReviewedContract = {
  cameraShots: [
    { id: "overview", fov: 48, position: [3.35, 2.75, 4.15], target: [0.05, 1, 0] },
  ...
  objects: {
    ...
    "confidence-band": {
      approvedGeometryDigest: "01a4301362d63ad12d8ca0db1527cc22f03642b74d80b70ac9f97ccac6e6a240",
      colorRole: "probe",
      conceptId: "confidence-interval",
      minimumWorldArcLength: 0.5,
      minimumWorldExtent: 0.5,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "estimate-probe": {
      ...
      pathObjectId: "sampling-distribution",
      requiredProjectionStates: allProjectionStates,
      type: "movingPoint"
    },
    "estimate-trace": {
      ...
      conceptId: null,
      requiredProjectionStates: ["playing"],
      sourceObjectId: "estimate-probe",
      type: "trace"
    },
    "interval-vector": {
      approvedGeometryDigest: "2115779239fc516cb87f04a81070bb4ebd15452d54dddae0778f450a9635a260",
      colorRole: "probe",
      conceptId: "confidence-interval",
      minimumWorldArcLength: 0.5,
      minimumWorldExtent: 0.5,
    ...
    "null-model-curve": {
      approvedGeometryDigest: "b8f00a8416a332d661e4961c4f05a1df123ed0d743d5d34710642ed7212b1234",
      colorRole: "trace",
      conceptId: "null-model",
      minimumWorldArcLength: 4.4,
      minimumWorldExtent: 4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "sampling-distribution": {
      approvedGeometryDigest: "2b6c21c89f07246c6a45b0e4d0de5bdc3e9c239592096065f67885a3d36d27b4",
      colorRole: "function",
      conceptId: "sample-estimate",
      minimumWorldArcLength: 4.5,
      minimumWorldExtent: 4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "test-statistic-vector": {
      approvedGeometryDigest: "376c333a2f31ccb016c7ecd8cb1612c28461a3038ef17ac9b244ec0635dd7102",
      colorRole: "trace",
      conceptId: "test-statistic",
      minimumWorldArcLength: 0.6,
      minimumWorldExtent: 0.6,
      requiredProjectionStates: allProjectionStates,
      type: "vector"
    }
  },
...
const statisticsDistributionReviewedContract = {
  cameraShots: [
    { id: "overview", fov: 48, position: [3.35, 2.75, 4.15], target: [0.05, 1, 0] },
  ...
  objects: {
    ...
    "dot-distribution": {
      approvedGeometryDigest: "226fe1dc04556786733eb937fab1b1e45bbf9b09c176714b1b3716d2c83a891c",
      colorRole: "probe",
      conceptId: "sample-distribution",
      minimumWorldArcLength: 4.5,
      minimumWorldExtent: 2.5,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    "histogram-ridge": {
      approvedGeometryDigest: "86ef256a9aa80b0e15e489d527dc172e3226e98508a936e95779d44cc53f928c",
      colorRole: "trace",
      conceptId: "sample-distribution",
      minimumWorldArcLength: 4.1,
      minimumWorldExtent: 4,
    ...
    "mean-vector": {
      approvedGeometryDigest: "fa3d0ce7d6c8576180d1f6bcee2a45d722bd55f5f07a2f6cabeebed9001ad6d3",
      colorRole: "probe",
    ...
    "normal-model-curve": {
      approvedGeometryDigest: "1daed93a34ba36020637ead8b26f92c3f0492783bba2cf717699627651fc38ca",
      colorRole: "function",
      conceptId: "normal-model",
      minimumWorldArcLength: 4.2,
      minimumWorldExtent: 4,
      requiredProjectionStates: animatedProjectionStates,
      type: "parametricCurve"
    },
    ...
    "sample-trace": {
      ...
      conceptId: null,
      requiredProjectionStates: ["playing"],
      sourceObjectId: "sample-probe",
      type: "trace"
    },
    "spread-vector": {
      approvedGeometryDigest: "482fce2f6bb0e2adbf85f6b73fdb8522da9de75b3cf3d52ef082629288779f26",
      colorRole: "trace",
      conceptId: "spread-rule",
      minimumWorldArcLength: 1.6,
      minimumWorldExtent: 1.6,
      requiredProjectionStates: allProjectionStates,
      type: "vector"
    }
  },
...
export const californiaPremiumWebGlReviewedContracts = {
  "us-ca-math-s2-chapter-02": functionFamilyReviewedContract,
  "us-ca-math-s3-chapter-02": functionFamilyReviewedContract,
  "us-ca-math-s3-chapter-03": functionGraphReviewedContract,
  "us-ca-math-s4-chapter-04": functionGraphReviewedContract,
  "us-ca-math-s4-chapter-05": probabilityMachineReviewedContract,
  "us-ca-math-s5-chapter-01": functionFamilyReviewedContract,
  "us-ca-math-s5-chapter-02": functionFamilyReviewedContract,
  "us-ca-math-s5-chapter-03": trigUnitWaveReviewedContract,
  "us-ca-math-s6-chapter-02": functionFamilyReviewedContract,
  "us-ca-math-s6-chapter-03": statisticalInferenceReviewedContract,
  "us-ca-math-s6-chapter-04": functionFamilyReviewedContract,
  "us-ca-math-s6-chapter-05": statisticsDistributionReviewedContract
