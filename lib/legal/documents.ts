...
// LEGAL REVIEW STATUS
// ------------------------------------------------------------------
// The owner confirmed legal-professional review of this final integrated copy.
// These statements must continue to describe actual product behaviour; any
// substantive edit needs a new version and renewed review-status assessment.
  ...
  sections: [
    {
      ...
      bullets: [
        ...
        },
        {
          ...
          zhHans: "学习记录：练习作答、错题、课程进度、掌握程度估算和作业提交。"
        },
        {
      ...
      paragraphs: [
        {
          ...
          zhHans: "平台提供的课程、题目和可视化内容仍属其各自拥有人所有。学生提交的作业仍属学生所有；平台存储这些内容，以便向该学生、其教师和监护人提供服务。"
        }
      ]
    },
    {
