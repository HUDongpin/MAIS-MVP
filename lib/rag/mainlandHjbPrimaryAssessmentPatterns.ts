...
import type {
  ...
  MainlandHjbPrimaryAssessmentPatternCard,
  MainlandHjbPrimaryAssessmentPatternEvidencePack,
...
function assessmentFamiliesFor(card: MainlandHjbPrimaryAssessmentPatternCard): MainlandHjbPrimaryAssessmentFamily[] {
  ...
  return uniqueValues([...(card.assessmentFamilies ?? []), ...mapped]) as MainlandHjbPrimaryAssessmentFamily[];
}

function cardSearchValues(card: MainlandHjbPrimaryAssessmentPatternCard) {
  return [
    card.grade,
    card.semester,
    card.sourceKind,
...
function intentScore(card: MainlandHjbPrimaryAssessmentPatternCard, query: MainlandHjbPrimaryAssessmentPatternQuery) {
...
function scoreCard(card: MainlandHjbPrimaryAssessmentPatternCard, query: MainlandHjbPrimaryAssessmentPatternQuery) {
...
function minimumRelevantScore(query: MainlandHjbPrimaryAssessmentPatternQuery) {
...
export function getMainlandHjbPrimaryAssessmentPatternCards(
  query: MainlandHjbPrimaryAssessmentPatternQuery
): MainlandHjbPrimaryAssessmentPatternCard[] {
  if (!queryAllowsPrimary(query.grade)) return [];

  const minimumScore = minimumRelevantScore(query);
  const scored = mainlandHjbPrimaryAssessmentPatternCards
...
export function buildMainlandHjbPrimaryAssessmentPatternEvidencePack(
  query: MainlandHjbPrimaryAssessmentPatternQuery
): MainlandHjbPrimaryAssessmentPatternEvidencePack {
  const cards = getMainlandHjbPrimaryAssessmentPatternCards(query);
  const evidenceText = [
