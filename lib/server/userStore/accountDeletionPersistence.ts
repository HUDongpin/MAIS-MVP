...
export const accountDeletionPlan: AccountDeletionPlan = {
  ...
  guardian_invitations: {
    purgeWhen: subjectOf("student_id", "consumed_by_parent_id", "created_by"),
    note: "Invitation tokens are removed when their learner, accepting parent, or issuer account is deleted; retaining them would leave an account-linked invitation or token behind."
  },
  guardian_links: {
...
const secretFieldsByTable: Record<string, readonly string[]> = {
  ...
  guardian_invitations: ["token_digest"]
};
