...
export function createAiGovernanceUserStore({
  ...
  return {
    ...
    getClassAiTutorPolicyForTeacher: aiGovernancePersistenceStore.getClassAiTutorPolicyForTeacher,
    updateClassAiTutorPolicy: aiGovernancePersistenceStore.updateClassAiTutorPolicy,
    resolveStudentAiTutorPolicy: aiGovernancePersistenceStore.resolveStudentAiTutorPolicy,
