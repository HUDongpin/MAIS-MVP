...
const hongKongTopics: Omit<Topic, "curriculumTrack">[] = [
  ...
  },
  {
    ...
    grade: "S5",
    title: { en: "Introduction to Differentiation (Extended Part)", zh: "微分入門（延伸部分）" },
    description: {
      en: "Extended Part (Module 1 or 2), not Compulsory Part: connect tangent gradients and rates of change.",
  ...
  },
  {
    ...
    title: { en: "Statistics", zh: "統計" },
    description: {
      en: "Use standard scores and standard deviation to interpret values in a normal distribution.",
      zh: "運用標準分數及標準差，解讀常態分佈中的數值。"
    },
    status: "not-started",
    difficulty: "High",
    minutes: 55,
