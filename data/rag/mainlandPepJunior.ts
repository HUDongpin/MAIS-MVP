...
export const mainlandPepJuniorRagCards: MainlandPepRagCard[] = [
  ...
  },
  {
    ...
    competencyTags: ["空间观念", "几何直观", "数学表达", "逻辑推理", "数感"],
    skillTags: ["邻补角与对顶角", "平行线性质", "定义命题定理", "平移与位置", "平方根与立方根", "实数分类与估算", "坐标表示", "象限判断"],
    misconceptionTags: [
      "angle relation inferred without line condition",
      "definition theorem and proposition confused",
      "translation direction and distance confused",
      "arithmetic square root treated as two roots",
      "irrational number estimate too coarse",
      "x and y coordinates swapped",
      "axis point quadrant mislabeled"
    ],
    safeSummary: "S1 lower links line-angle relationships, geometric language, translation, real-number foundations, and coordinate representation so learners can justify geometric conclusions, estimate roots, and locate or move points precisely.",
    generationGuidance: [
      "Design new angle configurations and require the line condition before applying an angle relation.",
      "Use original prompts for definition/proposition/theorem classification, translation movement, and root estimation.",
