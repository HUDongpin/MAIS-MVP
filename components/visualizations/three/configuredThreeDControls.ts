...
export function sliderBoundsForThreeDTemplate(templateId: VisualizationTemplateId, grade?: string): ThreeDTemplateSliderBounds {
  if (templateId === "base-ten" && grade === "K") {
    return { comparisonMax: 9, comparisonMin: 0, valueMax: 1, valueMin: 0 };
  }
  if (templateId === "base-ten" && grade === "P1") {
    return { comparisonMax: 9, comparisonMin: 0, valueMax: 9, valueMin: 0 };
  }
