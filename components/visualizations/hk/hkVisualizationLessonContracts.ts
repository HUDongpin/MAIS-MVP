...
export const HK_VISUALIZATION_LESSON_CONTRACTS = Object.freeze({
  ...
  "p6-pre-secondary-problem-solving": primary("p6-pre-secondary-problem-solving", {
    ...
    mustPromise: "Carry one budget problem through represent, plan, solve, and inverse-check states, with positive remaining or positive overspend.",
  ...
  "p2-multiplication-foundations": passThrough("p2-multiplication-foundations", {
    grade: "P2", modeIds: ["rows", "columns", "area"], parameterIds: ["value", "comparison"], stateKeys: ["columns", "rows", "area"],
    mustPromise: "Represent multiplication foundations as equal rows and columns whose total is rows × columns.",
    mustNotPromise: ["division with remainder"]
  }),
  ...
  "statistics-s1": passThrough("statistics-s1", {
    grade: "S1", modeIds: ["mean", "spread", "distribution"], parameterIds: ["value", "comparison"], stateKeys: ["mean", "spread"],
  ...
  "data-handling": passThrough("data-handling", {
    grade: "S4", modeIds: ["mean", "spread", "distribution"], parameterIds: ["value", "comparison"], stateKeys: ["mean", "spread"],
  ...
  "advanced-functions": passThrough("advanced-functions", {
    grade: "S5", modeIds: ["quadratic", "wave", "log-growth", "exponential"], parameterIds: ["value", "comparison"], stateKeys: ["family", "scale", "verticalShift"],
    mustPromise: "Compare quadratic, wave, logarithmic-growth, and exponential families with synchronized scale and vertical shift.",
    mustNotPromise: ["a single quadratic family"]
  }),
  "differentiation-intro": passThrough("differentiation-intro", {
    grade: "S5", modeIds: ["tangent", "secant", "area"], parameterIds: ["value", "comparison"], stateKeys: ["curvature", "probeX", "slope"],
    mustPromise: "Connect a curve, probe point, secant-to-tangent view, and instantaneous rate of change.",
    mustNotPromise: ["a derivative value unrelated to the plotted curve"]
  }),
  calculus: passThrough("calculus", {
    grade: "S6", modeIds: ["tangent", "secant", "area"], parameterIds: ["value", "comparison"], stateKeys: ["curvature", "probeX", "slope", "area"],
    mustPromise: "Explore tangent/secant rate and accumulated area on the same live function model.",
    mustNotPromise: ["unrelated rate and area functions"]
  })
