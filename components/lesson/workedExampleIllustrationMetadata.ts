...
const gradeOneWorkedExampleSceneOverrides: Record<string, WorkedExampleSceneOverride> = {
  ...
  "us-ca-math-p1-1-h1-picture-join-stories-to-10": {
    caption: "The worked example shows 4 red counters and 3 blue counters joining to make 7.",
    focusText: "4 + 3 = 7",
    kind: "counting",
    sceneId: "counters-red-blue-join"
  },
  "us-ca-math-p1-1-h2-picture-story-addition-equations": {
    caption: "The worked example shows 5 birds on a fence and 2 birds in a tree, matching the addition equation.",
    focusText: "5 + 2 = 7",
    kind: "counting",
    sceneId: "birds-fence-tree-addition"
  },
  "us-ca-math-p1-1-h3-cube-train-join-models-to-10": {
    caption: "The worked example shows a cube train with 6 green cubes and 2 yellow cubes joined into 8 cubes.",
    focusText: "6 + 2 = 8",
    kind: "counting",
    sceneId: "cube-train-green-yellow-join"
  },
  "us-ca-math-p1-1-h5-model-equation-join-stories-to-10": {
    caption: "The worked example shows a basket with 4 apples and 5 more apples joining to make 9.",
    focusText: "4 + 5 = 9",
    kind: "counting",
    sceneId: "apple-basket-join"
  },
  "us-ca-math-p1-1-h6-equation-match-join-stories-to-10": {
    caption: "The worked example shows 2 orange fish and 6 silver fish so the matching join equation is visible.",
    focusText: "2 + 6 = 8",
    kind: "counting",
    sceneId: "fish-equation-match-join"
  },
  "us-ca-math-p1-1-l1-picture-take-away-stories-to-10": {
    caption: "The worked example shows 9 balloons with 4 taken away and 5 left.",
    focusText: "9 - 4 = 5",
    kind: "counting",
    sceneId: "balloon-take-away"
  },
  "us-ca-math-p1-1-l2-picture-story-subtraction-equations": {
    caption: "The worked example shows 8 crackers with 3 taken away and 5 crackers left.",
    focusText: "8 - 3 = 5",
    kind: "counting",
    sceneId: "crackers-subtraction-equation"
  },
  "us-ca-math-p1-1-l3-cube-train-take-away-models-to-10": {
    caption: "The worked example shows 10 cubes with 6 covered so the 4 remaining cubes are clear.",
    focusText: "10 - 6 = 4",
    kind: "counting",
    sceneId: "cube-train-cover-take-away"
  },
  "us-ca-math-p1-1-l4-take-away-stories-within-10": {
    caption: "The worked example shows 7 stickers with 2 removed and 5 left.",
    focusText: "7 - 2 = 5",
    kind: "counting",
    sceneId: "sticker-take-away"
  },
  "us-ca-math-p1-1-l5-model-equation-take-away-stories-to-10": {
    caption: "The worked example shows 9 counters with 5 crossed out and 4 left.",
    focusText: "9 - 5 = 4",
    kind: "counting",
    sceneId: "counter-cross-out-take-away"
  },
  "us-ca-math-p1-1-l6-break-apart-subtraction-equations-to-10": {
    caption: "The worked example shows 10 shells split into 4 in a box and 6 outside the box.",
    focusText: "10 = 4 + 6",
    kind: "counting",
    sceneId: "shells-break-apart-subtraction"
  }
};
