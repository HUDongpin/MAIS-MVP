  ...
  return (
    <div className="prose-lesson max-w-none">
      ...
      <p>
        ...
        number, and its square root {modulus} is the <strong>modulus</strong>{" "}
      ...
      <MathCheck>
        <p>
          ...
          <strong>quotient</strong>{" "}z/w is computed by multiplying numerator and
          denominator by w̄ to make the denominator real (N-CN.3). The identity{" "}
  ...
  return (
    <div className="flex flex-col items-center gap-1">
      ...
      <div className="flex items-center gap-2">
        <button type="button" onClick={() => onChange(Math.max(-9, value - 1))} className="h-9 w-9 rounded-lg border border-[var(--line)] bg-[var(--surface)] text-lg font-bold" aria-label={`Decrease ${label}`}>−</button>
