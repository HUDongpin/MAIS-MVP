    ...
    <div className="prose-lesson max-w-none">
      ...
      <Figure caption="From a known distance and angle of elevation, tangent gives the height.">
        <div className="flex flex-col items-center gap-6">
          <svg width={260} height={180} viewBox="0 0 260 180" role="img" aria-label={`A ${angle} degree angle of elevation measured ${dist} meters from a building, giving a height of about ${height} meters`}>
            {/* ground */}
