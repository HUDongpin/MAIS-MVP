  ...
  return (
    <div className="prose-lesson max-w-none">
      ...
      <p>
        ...
        mth power. Here {base}<sup>{m}/{n}</sup> = {value}. The rule for integer
      ...
      <MathCheck>
        <p>
          ...
          the integer-exponent laws (N-RN.1): defining b<sup>1/n</sup> as the{" "}
