...
import { legalDocumentsReviewedByCounsel } from "@/lib/legal/policyVersion";
...
const legalCopy = {
  ...
  reviewedNotice: {
    en: "Reviewed by legal professionals.",
    zh: "經法律專業人員審定。",
    zhHans: "经过法律专业人员审定。"
  },
    ...
    <div className="page-container py-10 sm:py-14">
      <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[minmax(0,1fr)_280px]">
        <article className="glass-panel p-6 sm:p-8">
          ...
          <p
            role="note"
            className={legalDocumentsReviewedByCounsel
              ? "mt-5 rounded-2xl border border-emerald-300/50 bg-emerald-400/10 px-4 py-3 text-sm font-semibold text-emerald-900 dark:border-emerald-300/20 dark:text-emerald-100"
              : "mt-5 rounded-2xl border border-amber-300/50 bg-amber-400/10 px-4 py-3 text-sm font-semibold text-amber-900 dark:border-amber-300/20 dark:text-amber-100"}
          >
            {t(legalDocumentsReviewedByCounsel ? legalCopy.reviewedNotice : legalCopy.draftNotice)}
          </p>
