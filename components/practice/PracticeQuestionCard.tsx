...
import type { AttemptFeedback, PublicQuestion, QuestionType } from "@/types";
...
export function PracticeQuestionCard({ question, onAnswered }: PracticeQuestionCardProps) {
  ...
  return (
    <article className="glass-panel p-5" data-question-id={question.id}>
      ...
      {question.diagram ? <QuestionFigure diagram={question.diagram} variant={diagramVariant} compact={isPracticePage} language={language} /> : null}
