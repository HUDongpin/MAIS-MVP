...
export const PROMOTION_SHADOW_CLOSURE_V2_PATH =
  "coordination/integration/pilots/us-ca-math-rag-v2-g6-ratios-v2/attempt-005/shadow-closure.v2.json";
export const PROMOTION_LIFECYCLE_REGISTRY_V2_PATH =
  "coordination/integration/pilots/us-ca-math-rag-v2-g6-ratios-v2/attempt-005/lifecycle-registry.v2.json";
...
function validateManifestAndReceipt(closure, values) {
  ...
  if (
    ...
    fail("V2_FINALIZATION_RECEIPT_MISMATCH", "Canonical Receipt is stale or not a passing non-live attempt-005 Receipt.");
  }
