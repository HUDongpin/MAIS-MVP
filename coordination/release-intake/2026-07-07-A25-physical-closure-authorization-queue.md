...
Generated: 2026-07-07T15:59:35.644Z
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 4004 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 476 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 5728 | A25, A10, A22, effective file owners |
