...
Generated: 2026-07-08T15:22:42.316Z
...
| ---: | --- | --- | --- | --- | ---: | --- |
| 1 | `codex/A22-us-region-alignment` | controlled-mutated-root-parity-recovery | behind 2, ahead 1 | no | 9 | Validate as a bounded A22 recovery candidate only; the worktree may stay dirty only by the four authorized root-parity target rows until an explicit owner staging/commit decision exists. |
