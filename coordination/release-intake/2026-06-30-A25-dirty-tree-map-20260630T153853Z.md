...
Generated at: 2026-06-30T15:38:59.582Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 dirty-worktree remediation aggregate gate outputs
Status signature: `6dfe8c99500d3c8ff5fab382ab0618dcc94573fca866ac671bc97372414e47ee`

## Counts

- Collapsed status entries: 1223
- Expanded status entries: 2470
- Tracked modified: 390
- Tracked deleted: 1
- Untracked status entries: 832
- Untracked files: 2079

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 948 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1326 |
