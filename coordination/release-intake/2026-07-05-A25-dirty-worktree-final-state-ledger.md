...
Generated: 2026-07-05T11:12:18.149Z
...
| --- | --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | owner-package | A25 git hygiene and release intake | root package has 3030 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `owner-package:a10-tooling-docs-and-report` | owner-package | A10 tooling, docs, and report | root package has 459 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `physical:root-main` | physical-lifecycle | main | dirty 4737 | approved-reviewed-owner-package-commit | reviewed owner package commit |
...
- Path: n/a
- Package/lifecycle kind: release-hygiene
- Current blocker: root package has 459 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Approved by: Owner approval via Codex goal
- Approved at: 2026-07-05T11:12:18.100Z
