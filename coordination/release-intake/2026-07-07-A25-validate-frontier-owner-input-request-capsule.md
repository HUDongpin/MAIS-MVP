...
Generated: 2026-07-07T15:08:05.303Z
...
- Owner-package focus pending rows: 3
- A22 selectedAction rows: 4
- A22 owner-input landing runway status: `ready-for-owner-input-landing-review`
- A22 owner input blank: yes
...
| --- | --- | ---: | ---: | --- | --- |
| `owner-package-canonical-authorization-focus-batch` | ready-for-owner-review | 3 | 0 | `coordination/release-intake/latest-A25-next-owner-authorizations.json` | canonical-owner-package-authorization |
| `a22-root-parity-selected-actions` | waiting-for-owner-action | 4 | 0 | `coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json` | a22-root-parity-selected-action-owner-input |
...
- Landing runway status: `ready-for-owner-input-landing-review`
- Owner input blank: yes
- Landing patch rows: 4
- Post-owner-input validation commands: 8
- Candidate targets missing: 4/4
- Instruction intake status: `waiting-for-owner-input`
- Instruction recording status: `dry-run-blocked-owner-input`
- Guarded extraction status: `dry-run-blocked-missing-recorded-instructions`
- Candidate mutation executor status: `dry-run-blocked-missing-recorded-instructions`
- Candidate mutation owner input blank: yes
- Candidate mutation recorded instruction rows: 0/4
...
| `owner-package-focus-ready-for-owner-review` | pass | previewStatus=ready-for-owner-review; pendingRows=3 |
| `a22-selected-actions-waiting-for-owner` | pass | acceptanceStatus=waiting-for-owner-action; previewStatus=ready-for-owner-review; acceptanceRows=4; acceptedRows=0 |
| `a22-owner-input-landing-runway-ready` | pass | runwayStatus=ready-for-owner-input-landing-review; patchRows=4; postOwnerInputValidationCommands=8; candidateTargetsMissing=4 |
