...
Generated: 2026-07-10T17:03:45.803Z

Focus status: `post-extraction-verified`
...
- Guarded candidate targets missing: 0
- Guarded candidate git status rows: 7
- Root copy rows: 0
...
| `guarded-extraction-lifecycle-safe` | pass | executorStatus=already-extracted-and-verified; candidateMutationRows=0 |
