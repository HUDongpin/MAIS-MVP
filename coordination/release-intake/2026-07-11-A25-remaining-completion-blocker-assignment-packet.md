...
| ID | Status | Label | Blocking reason |
| --- | --- | --- | --- |
| `task-4-wave02` | incomplete | Task 4 shared contract/backend package closure | 1 dirty entries are outside the A08/A12 pathspec union; testAnalytics failed; testBackend failed; typeCheck failed; build failed |
