...
Generated at: 2026-06-30T15:36:57.611Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 dirty-worktree remediation aggregate gate
Status signature: `cd1f4fa9d12b93165fe7e723fec5a603792b810910d0f3ac774ea7583e7b9bc9`

## Counts

- Collapsed status entries: 1223
- Expanded status entries: 2466
- Tracked modified: 390
- Tracked deleted: 1
- Untracked status entries: 832
- Untracked files: 2075

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 944 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1322 |
