...
Generated at: 2026-06-30T07:19:10.110Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 dirty-worktree closure baseline after helper owner rules
Status signature: `63047f4e2e21c657e874ef572b794939dd53fc8f12e3f411dce8443a93a59139`

## Counts

- Collapsed status entries: 1208
- Expanded status entries: 2188
- Tracked modified: 385
- Tracked deleted: 1
- Untracked status entries: 822
- Untracked files: 1802

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 756 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1130 |
