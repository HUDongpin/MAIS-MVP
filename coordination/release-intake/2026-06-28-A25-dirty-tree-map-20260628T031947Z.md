...
Generated at: 2026-06-28T03:19:52.357Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-local-runtime-cleanup-currentness-2026-06-28
Status signature: `d442027a2845c8762fcb45dce9ecf89e1bb8ba4d8c7f2aefa70623adf9609d33`

## Counts

- Collapsed status entries: 1092
- Expanded status entries: 1889
- Tracked modified: 381
- Tracked deleted: 1
- Untracked status entries: 710
- Untracked files: 1507

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 573 |
| A06 visualization lead | 355 |
| A10 tooling, docs, and report | 181 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 918 |
