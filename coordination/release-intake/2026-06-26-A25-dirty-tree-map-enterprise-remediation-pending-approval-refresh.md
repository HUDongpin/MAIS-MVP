...
Generated at: 2026-06-26T11:05:25.953Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 pending approval refresh
Status signature: `5a85211bc1e99d96db29c1715985a29a59befa5fd16b8d0e9ff489ba8a83979f`

## Counts

- Collapsed status entries: 963
- Expanded status entries: 1637
- Tracked modified: 367
- Tracked deleted: 0
- Untracked status entries: 596
- Untracked files: 1270

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 461 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 759 |
