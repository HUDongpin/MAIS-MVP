...
Generated: 2026-07-06T15:46:55.248Z
...
- Dirty linked worktree requests: 29
- Clean-diverged branch requests: 9
...
| --- | --- | --- | --- | --- | --- |
| `root-main` | `main` | root-owner-package | dirty 5183 | A25, A10, A22, effective file owners | reviewed owner package commit; owner-approved exact-path discard; evidence archive with release-source blocker; blocker |
...
| `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | clean-diverged-branch | behind 2, ahead 1 | A22 | owner-approved PR or review package; archive-state record; owner-approved branch or worktree retirement; blocker |
