...
Generated at: 2026-07-02T16:05:41.250Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: 2026-07-02 A22 production deploy post-cache-cleanup current MAIS-MVP to www.mais.hk and www.mais.ac
Status signature: `974c9d2d1724e094f72706dbe4cb01caf6b5e8795491e47e0c1973c5ebc1c2a5`

## Counts

- Collapsed status entries: 1426
- Expanded status entries: 3632
- Tracked modified: 389
- Tracked deleted: 1
- Untracked status entries: 1036
- Untracked files: 3242

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 1894 |
| A06 visualization lead | 445 |
| A10 tooling, docs, and report | 396 |
| A12 backend/API platform | 175 |
| A18 curriculum QA / A21 content pipeline | 138 |
| A05 lesson lead | 126 |
| A21 content pipeline and RAG operations | 74 |
| A22 production reliability and release engineering | 67 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 2479 |
| runtime app/API/data/public | 678 |
| tests/regression evidence | 377 |
