# 2026-06-26 A25 Effective Work Order - A06 visualization lead
...
- Entries: 308
- From P0 proposals: 1
- Dominant slice: runtime app/API/data/public: 164
...
```bash
git status --short --pathspec-from-file=coordination/release-intake/latest-A25-effective-owner-a06-visualization-lead.pathspec
git diff --stat --pathspec-from-file=coordination/release-intake/latest-A25-effective-owner-a06-visualization-lead.pathspec
```
...
- `M` `data/visualizationLabs.ts` (from P0 proposal)
...
- `??` `components/visualizations/three/manim/mathCameraDirector.test.ts`
