...
- Next actions:
  - A25/A10/A22 must request exact owner approval for package-only resync or uncovered-path classification before any restore, clean, or discard.
