...
Generated at: 2026-06-26T11:00:42.189Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 owner approval matrix post-report final inventory
Status signature: `78d235b0c2bd42e6777bcb8040614d24a7e404c00bca6e39fcabc6988ccdb969`

## Counts

- Collapsed status entries: 962
- Expanded status entries: 1634
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 596
- Untracked files: 1268

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 459 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 757 |
| runtime app/API/data/public | 499 |
| tests/regression evidence | 292 |
