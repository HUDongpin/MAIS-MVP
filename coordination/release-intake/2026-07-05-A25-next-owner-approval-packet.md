...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 3030 | root package has 3030 dirty entries |
...
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 459 | root package has 459 dirty entries |
...
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 4737 | A25, A10, A22, effective file owners |
