...
Generated at: 2026-06-28T03:17:52.888Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-local-runtime-smoke-2026-06-28
Status signature: `b548d9731a83dc2c3a7bc3948a0d90989127d2a4477b960fa5924a4f0f16d581`

## Counts

- Collapsed status entries: 1092
- Expanded status entries: 1887
- Tracked modified: 381
- Tracked deleted: 1
- Untracked status entries: 710
- Untracked files: 1505

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 571 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 916 |
