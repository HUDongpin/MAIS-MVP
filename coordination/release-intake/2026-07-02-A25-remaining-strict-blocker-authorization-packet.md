...
Generated: 2026-07-02T15:39:02.199Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 3505 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
