...
Generated at: 2026-06-26T10:41:38.112Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 lifecycle decision request gate stable inventory
Status signature: `3ee7024f07e8a960e504fc0f9c4ec6cd6d6810ebd267190e0afbffa4b7061033`

## Counts

- Collapsed status entries: 961
- Expanded status entries: 1605
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 595
- Untracked files: 1239

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 431 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 729 |
