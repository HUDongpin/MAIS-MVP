...
Generated: 2026-07-01T15:44:04.866Z
...
- Dirty linked worktree requests: 27
...
| --- | --- | --- | --- | --- | --- |
| `root-main` | `main` | root-owner-package | dirty 2923 | A25, A10, A22, effective file owners | reviewed owner package commit; owner-approved exact-path discard; evidence archive with release-source blocker; blocker |
...
| `codex-a02-a15-dashboard-adaptive-closure` | `codex/A02-A15-dashboard-adaptive-closure` | dirty-linked-worktree | dirty 30 | A02, A15 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a03-roadmap-closure` | `codex/A03-roadmap-closure` | dirty-linked-worktree | dirty 30 | A03 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a04-practice-closure` | `codex/A04-practice-closure` | dirty-linked-worktree | dirty 56 | A04 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a05-lesson-closure` | `codex/A05-lesson-closure` | dirty-linked-worktree | dirty 126 | A05 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
| `codex-a07-ai-tutor-closure` | `codex/A07-ai-tutor-closure` | dirty-linked-worktree | dirty 12 | A07 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
| `codex-a09-copy-i18n-accessibility-closure` | `codex/A09-copy-i18n-accessibility-closure` | dirty-linked-worktree | dirty 5 | A09 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
| `codex-a11-regression-evidence-closure` | `codex/A11-regression-evidence-closure` | dirty-linked-worktree | dirty 62 | A11 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
| `codex-a13-a14-console-closure` | `codex/A13-A14-console-closure` | dirty-linked-worktree | dirty 43 | A13, A14 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a16-research-evidence-closure` | `codex/A16-research-evidence-closure` | dirty-linked-worktree | dirty 6 | A16 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a17-a20-game-motivation-closure` | `codex/A17-A20-game-motivation-closure` | dirty-linked-worktree | dirty 21 | A17, A20 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
| `codex-a18-a21-content-evidence-closure` | `codex/A18-A21-content-evidence-closure` | dirty-linked-worktree | dirty 222 | A18, A21 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
