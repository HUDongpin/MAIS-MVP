# 2026-07-07 A25 Dirty-Tree Map

Generated at: 2026-07-07T13:41:04.562Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: validation hold confirmation recorder aggregate staleness refresh
Status signature: `2294fedab78c2854ea5c09bb79e06829763171fcfd4ab91dee140abc63ef0b6b`

## Counts

- Collapsed status entries: 1464
- Expanded status entries: 5696
- Tracked modified: 391
- Tracked deleted: 1
- Untracked status entries: 1072
- Untracked files: 5304

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 3972 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 4521 |
