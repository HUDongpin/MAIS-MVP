# A25 Dirty-Worktree Final-State Action Runbook

Generated: 2026-07-10T17:08:20.366Z

Dirty map signature: `e30d647e1b51432945713f42ac78b0a2466fcb17192de0235a801ac877a0801f`

Expanded dirty entries: 7636

Selection source: `coordination/release-intake/latest-A25-dirty-worktree-final-state-selection.json`

Rows: 65

Executable rows now: 0

- owner-reviewed-commit-required: 27
- owner-reviewed-worktree-package-required: 30
- owner-approved-pr-or-review-package-required: 8
...
| --- | --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a22-production-reliability-and-release-engineering` | A22 production reliability and release engineering | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a06-visualization-lead` | A06 visualization lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a12-backend-api-platform` | A12 backend/API platform | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a11-qa-and-release-quality` | A11 QA and release quality | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a10-tooling-docs-and-report` | A10 tooling, docs, and report | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a05-lesson-lead` | A05 lesson lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a21-content-pipeline-and-rag-operations` | A21 content pipeline and RAG operations | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a04-practice-lead` | A04 practice lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a18-curriculum-qa-a21-content-pipeline` | A18 curriculum QA / A21 content pipeline | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a03-curriculum-roadmap-lead` | A03 curriculum roadmap lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a24-illustration-exact-layer` | A24 illustration exact-layer | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a13-teacher-console` | A13 teacher console | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a01-app-shell-lead` | A01 app shell lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a02-dashboard-lead` | A02 dashboard lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a20-game-design-and-game-based-learning` | A20 game design and game-based learning | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a07-ai-tutor-lead` | A07 AI tutor lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a08-state-and-analytics-lead` | A08 state and analytics lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a15-adaptive-engine-lead` | A15 adaptive engine lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a14-parent-console` | A14 parent console | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:manual-a10-a25-owner-assignment-required` | Manual A10/A25 owner assignment required | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a09-copy-i18n-accessibility` | A09 copy, i18n, accessibility | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a17-gamification-and-motivation` | A17 gamification and motivation | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a23-integration-and-promotion-lead` | A23 integration and promotion lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a13-teacher-console-lead` | A13 teacher console lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `owner-package:a18-curriculum-qa-and-content-quality-lead` | A18 curriculum QA and content quality lead | approved-reviewed-commit | reviewed commit | owner-reviewed-commit-required | no |
| `physical:root-main` | main | approved-reviewed-owner-package-commit | reviewed owner package commit | owner-reviewed-commit-required | no |
| `physical:codex-a01-app-shell-closure` | codex/A01-app-shell-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a01-shell-lazy-load` | codex/A01-shell-lazy-load | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a02-a15-dashboard-adaptive-closure` | codex/A02-A15-dashboard-adaptive-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a03-roadmap-closure` | codex/A03-roadmap-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a04-practice-closure` | codex/A04-practice-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a05-lesson-checklist-p0` | codex/A05-lesson-checklist-p0 | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a05-lesson-closure` | codex/A05-lesson-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a05-lesson-pep-load` | codex/A05-lesson-pep-load | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a05-next-item-button-scroll` | codex/A05-next-item-button-scroll | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a06-manim-three-closure` | codex/A06-manim-three-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a06-visualization-closure` | codex/A06-visualization-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a07-a15-a08-ai-adaptive-types` | codex/A07-A15-A08-ai-adaptive-types | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a07-ai-tutor-classroom-switches` | codex/A07-ai-tutor-classroom-switches | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a07-ai-tutor-closure` | codex/A07-ai-tutor-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a08-a12-shared-contract-closure` | codex/A08-A12-shared-contract-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a09-copy-i18n-accessibility-closure` | codex/A09-copy-i18n-accessibility-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a10-a22-a08-a12-a06-compose-20260628` | codex/A10-A22-A08-A12-A06-compose-20260628 | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a10-a22-release-governance` | codex/A10-A22-release-governance | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a11-fix-126-128-129` | codex/A11-fix-126-128-129 | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a11-regression-evidence-closure` | codex/A11-regression-evidence-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a12-google-oauth-login` | codex/A12-google-oauth-login | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a12-userstore-storage-contract` | codex/A12-userstore-storage-contract | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a13-a14-console-closure` | codex/A13-A14-console-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a16-research-evidence-closure` | codex/A16-research-evidence-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a17-a20-game-motivation-closure` | codex/A17-A20-game-motivation-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a18-a21-content-evidence-closure` | codex/A18-A21-content-evidence-closure | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a19-vercel-postgres-region` | codex/A19-vercel-postgres-region | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a22-missing-module-release-slice` | codex/A22-missing-module-release-slice | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a22-next-15-5-19-audit` | codex/A22-next-15-5-19-audit | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a22-p1-release-hygiene-security` | codex/A22-p1-release-hygiene-security | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a22-us-region-alignment` | codex/A22-us-region-alignment | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a25-ci-backup-workflow` | codex/A25-ci-backup-workflow | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-a25-dirty-closure-governance` | codex/A25-dirty-closure-governance | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a25-full-dirty-compose-verification` | codex/A25-full-dirty-compose-verification | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-a14-profile-avatar-save` | codex/A14-profile-avatar-save | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-visualization-production-release` | codex/visualization-production-release | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction | owner-reviewed-worktree-package-required | no |
| `physical:codex-california-practice-beta-clean` | codex/california-practice-beta-clean | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
| `physical:codex-s22-release-hygiene-2026-06-15` | codex/s22-release-hygiene-2026-06-15 | approved-owner-approved-pr-or-review-package | owner-approved PR or review package | owner-approved-pr-or-review-package-required | no |
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 5702 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 178 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 64 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 490 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 129 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 76 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 60 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 45 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 168 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
- Branch: n/a
- Path: n/a
- Current blocker: root package has 37 dirty entries
- Decision status: approved-reviewed-commit
- Selected final state: reviewed commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
...
## owner-package:manual-a10-a25-owner-assignment-required
...
- Current blocker: dirty 7636
- Decision status: approved-reviewed-owner-package-commit
- Selected final state: reviewed owner package commit
- Action kind: owner-reviewed-commit-required
- Executable now: no
- Required preconditions:
  - dirty map is current
...
- Decision status: approved-owner-reviewed-commit-or-package-extraction
- Selected final state: owner-reviewed commit or package extraction
- Action kind: owner-reviewed-worktree-package-required
- Executable now: no
- Required preconditions:
  - dirty map is current
  - owner decision packet is current
...
- Decision status: approved-owner-approved-pr-or-review-package
- Selected final state: owner-approved PR or review package
- Action kind: owner-approved-pr-or-review-package-required
- Executable now: no
- Required preconditions:
  - dirty map is current
  - owner decision packet is current
