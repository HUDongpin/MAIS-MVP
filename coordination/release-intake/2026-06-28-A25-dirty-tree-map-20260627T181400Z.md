...
Generated at: 2026-06-27T18:14:04.798Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-auth-shared-helper-after-scoped-cleanup-2026-06-28
Status signature: `68760b95eb3b46e44363fe632630775d8b019e142954b155ea5d2e960ada92f8`

## Counts

- Collapsed status entries: 1090
- Expanded status entries: 1861
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 707
- Untracked files: 1478

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 547 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 889 |
