...
Generated: 2026-07-06T15:50:16.623Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `wave-01-governance-release-hygiene` | `wave-01-governance-release-hygiene` | A25 git hygiene and release intake, A22 production reliability and release engineering, A10 tooling, docs, and report | blocked | 1012 | 3 | 404 | 1 |
...
- Blocking reasons: 1 held package-resync row remains: wave01-resync-01-tsconfig-json; npm audit --audit-level=high failed or unavailable; release helper tests failed; npm run type-check failed
- Pathspecs:
