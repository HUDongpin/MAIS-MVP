...
Generated at: 2026-06-26T12:59:17.565Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: AI Tutor Qwen-only latency release slice
Status signature: `7fb7da3718586ac15e2f6d8f135fcad02a7d0abd1de759d61a0a7147d15d3190`

## Counts

- Collapsed status entries: 967
- Expanded status entries: 1671
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 601
- Untracked files: 1305

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 491 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 793 |
