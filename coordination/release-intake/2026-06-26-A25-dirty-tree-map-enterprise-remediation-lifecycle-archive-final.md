...
Generated at: 2026-06-26T09:51:27.933Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 lifecycle gate and visualization evidence archive final inventory
Status signature: `7fbac131d8e92c70976f4178c45bfc1bab00314d8ceedbbd140144559995abd2`

## Counts

- Collapsed status entries: 957
- Expanded status entries: 1349
- Tracked modified: 365
- Tracked deleted: 0
- Untracked status entries: 592
- Untracked files: 984
...
| A25 git hygiene and release intake | 179 |
| A12 backend/API platform | 160 |
| A10 tooling, docs, and report | 148 |
...
| Slice | Dirty entries |
| --- | ---: |
| runtime app/API/data/public | 497 |
| docs/coordination evidence | 476 |
| tests/regression evidence | 290 |
