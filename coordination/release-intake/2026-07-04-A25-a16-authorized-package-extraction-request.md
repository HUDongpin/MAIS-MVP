...
Generated: 2026-07-04T15:50:04.136Z
...
| `owner-candidate-blocked-for-exact-command` | pass | The request exists to close this exact-command gap. |
...
| `status-file-count` | pass | statusRows=6 |
| `all-paths-untracked-research-evidence` | pass | Every package path must remain untracked coordination/research evidence. |
| `acceptance-docket-authorized` | pass | A16 ready-candidate owner docket reflects both recorded approvals. |
| `preview-requires-separate-instruction` | pass | Both rows still require a separate owner execution instruction. |
