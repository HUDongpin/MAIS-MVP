...
Generated: 2026-07-10T17:08:26.177Z
...
- Owner package approval IDs: 26
- Physical lifecycle approval IDs: 39
- Total approval IDs: 65
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 5702 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 4 | `a12-backend-api-platform` | A12 backend/API platform | P2 | 178 | `coordination/release-intake/latest-A25-effective-owner-a12-backend-api-platform.pathspec` |
| 5 | `a11-qa-and-release-quality` | A11 QA and release quality | P2 | 64 | `coordination/release-intake/latest-A25-effective-owner-a11-qa-and-release-quality.pathspec` |
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 490 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
| 7 | `a05-lesson-lead` | A05 lesson lead | P3 | 129 | `coordination/release-intake/latest-A25-effective-owner-a05-lesson-lead.pathspec` |
| 8 | `a21-content-pipeline-and-rag-operations` | A21 content pipeline and RAG operations | P3 | 76 | `coordination/release-intake/latest-A25-effective-owner-a21-content-pipeline-and-rag-operations.pathspec` |
| 9 | `a04-practice-lead` | A04 practice lead | P3 | 60 | `coordination/release-intake/latest-A25-effective-owner-a04-practice-lead.pathspec` |
| 10 | `a18-curriculum-qa-a21-content-pipeline` | A18 curriculum QA / A21 content pipeline | P3 | 45 | `coordination/release-intake/latest-A25-effective-owner-a18-curriculum-qa-a21-content-pipeline.pathspec` |
...
| 12 | `a24-illustration-exact-layer` | A24 illustration exact-layer | P4 | 168 | `coordination/release-intake/latest-A25-effective-owner-a24-illustration-exact-layer.pathspec` |
| 13 | `a13-teacher-console` | A13 teacher console | P4 | 37 | `coordination/release-intake/latest-A25-effective-owner-a13-teacher-console.pathspec` |
| 14 | `a01-app-shell-lead` | A01 app shell lead | P4 | 31 | `coordination/release-intake/latest-A25-effective-owner-a01-app-shell-lead.pathspec` |
| 15 | `a02-dashboard-lead` | A02 dashboard lead | P4 | 22 | `coordination/release-intake/latest-A25-effective-owner-a02-dashboard-lead.pathspec` |
| 16 | `a20-game-design-and-game-based-learning` | A20 game design and game-based learning | P4 | 16 | `coordination/release-intake/latest-A25-effective-owner-a20-game-design-and-game-based-learning.pathspec` |
| 17 | `a07-ai-tutor-lead` | A07 AI tutor lead | P4 | 12 | `coordination/release-intake/latest-A25-effective-owner-a07-ai-tutor-lead.pathspec` |
| 18 | `a08-state-and-analytics-lead` | A08 state and analytics lead | P4 | 11 | `coordination/release-intake/latest-A25-effective-owner-a08-state-and-analytics-lead.pathspec` |
| 19 | `a15-adaptive-engine-lead` | A15 adaptive engine lead | P4 | 9 | `coordination/release-intake/latest-A25-effective-owner-a15-adaptive-engine-lead.pathspec` |
...
| 21 | `manual-a10-a25-owner-assignment-required` | Manual A10/A25 owner assignment required | P4 | 7 | `coordination/release-intake/latest-A25-effective-owner-manual-a10-a25-owner-assignment-required.pathspec` |
...
| 25 | `a13-teacher-console-lead` | A13 teacher console lead | P4 | 1 | `coordination/release-intake/latest-A25-effective-owner-a13-teacher-console-lead.pathspec` |
| 26 | `a18-curriculum-qa-and-content-quality-lead` | A18 curriculum QA and content quality lead | P4 | 1 | `coordination/release-intake/latest-A25-effective-owner-a18-curriculum-qa-and-content-quality-lead.pathspec` |

## Physical Lifecycle Queue

| Order | Approval ID | Branch | Kind | Current blocker | Owner hints |
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 7636 | A25, A10, A22, effective file owners |
...
| 16 | `codex-a08-a12-shared-contract-closure` | `codex/A08-A12-shared-contract-closure` | dirty-diverged-worktree | dirty 186 | A08, A12 |
...
| 29 | `codex-a22-missing-module-release-slice` | `codex/A22-missing-module-release-slice` | dirty-diverged-worktree | dirty 1017 | A22 |
