...
Generated at: 2026-06-26T11:23:10.518Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 intake for bug-ui-fix-only release candidate to www.mais.hk and www.mais.ac
Status signature: `418a50fd4dc514911d158c26d8b9666e3efd922dcede18d68b45ee8facebfd43`

## Counts

- Collapsed status entries: 964
- Expanded status entries: 1650
- Tracked modified: 367
- Tracked deleted: 0
- Untracked status entries: 597
- Untracked files: 1283

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 473 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 771 |
