...
Generated: 2026-07-06T15:47:00.549Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 5183 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
