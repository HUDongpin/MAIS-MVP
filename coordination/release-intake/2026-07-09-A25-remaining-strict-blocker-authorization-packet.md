...
Generated: 2026-07-09T14:10:26.056Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 6604 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
