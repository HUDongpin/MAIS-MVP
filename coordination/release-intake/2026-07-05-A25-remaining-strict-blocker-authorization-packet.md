...
Generated: 2026-07-05T11:12:22.730Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 4737 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
...
| `physical:codex-a22-us-region-alignment` | codex/A22-us-region-alignment | clean-diverged-open-decision | behind 2, ahead 1 | Owner must choose PR/review package, archive-state record, branch/worktree retirement, or continued blocker handling for the diverged branch. |
