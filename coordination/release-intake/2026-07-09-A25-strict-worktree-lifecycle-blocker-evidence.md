...
Generated: 2026-07-09T14:10:31.387Z
...
- Owner package approvals needed: 25
- Physical lifecycle approvals needed: 39
- Total approvals needed: 64
- Cleanup-authorized rows: 0
- Executable rows: 0
...
| `- open lifecycle decision: main: dirty (6604 entries)` |
...
| `{` |
| `  "checkedAt": "2026-07-09T14:10:31.374Z",` |
| `  "root": "/Users/dongpinhu/Desktop/MAIS-MVP",` |
| `  "strict": true,` |

## Open Lifecycle Decisions

- Row signature: `fd96d4e697d062ae222745d0d84a5f592de540a4774376c3f3d8ffc459fdd35e`
...
| ---: | --- | --- | ---: | --- | --- |
| 1 | `main` | dirty-open-decision | 6604 | 0/0 | no |
