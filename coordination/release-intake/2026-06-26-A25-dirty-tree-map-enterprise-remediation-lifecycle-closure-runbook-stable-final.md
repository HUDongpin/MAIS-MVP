...
Generated at: 2026-06-26T10:48:41.184Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 lifecycle closure runbook gate stable inventory
Status signature: `60e96b77578d3d50fa2a6f2f598ec690f48f35e7fe46e2afa1e6d7658dc8d3b4`

## Counts

- Collapsed status entries: 961
- Expanded status entries: 1616
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 595
- Untracked files: 1250

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 442 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 740 |
