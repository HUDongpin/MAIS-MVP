...
Generated: 2026-07-04T15:59:50.656Z
...
- Physical lifecycle approval IDs: 38
- Total approval IDs: 62
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 2614 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 455 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
...
| 20 | `a16-research-and-learning-science` | A16 research and learning science | P4 | 6 | `coordination/release-intake/latest-A25-effective-owner-a16-research-and-learning-science.pathspec` |
| 21 | `a24-illustration-exact-layer` | A24 illustration exact-layer | P4 | 6 | `coordination/release-intake/latest-A25-effective-owner-a24-illustration-exact-layer.pathspec` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 4323 | A25, A10, A22, effective file owners |
...
| 35 | `codex-a14-profile-avatar-save` | `codex/A14-profile-avatar-save` | dirty-linked-worktree | dirty 10 | A14 |
| 36 | `codex-visualization-production-release` | `codex/visualization-production-release` | dirty-diverged-worktree | dirty 16 | A06, A22 |
| 37 | `codex-california-practice-beta-clean` | `codex/california-practice-beta-clean` | clean-diverged-branch | behind 13, ahead 1 | A21, A18, A04, A22 |
| 38 | `codex-s22-release-hygiene-2026-06-15` | `codex/s22-release-hygiene-2026-06-15` | clean-diverged-branch | behind 13, ahead 1 | A22, A10 |
