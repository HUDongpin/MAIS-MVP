...
- record-a25-owner-package-authorizations: dry-run-blocked-owner-approval-placeholders; rows=1; executableNow=false
...
- [pass] owner-response-still-waiting: packetStatus=waiting-for-owner-response; frontierOwnerRows=1
- [pass] recorders-fail-closed-until-owner-response: record-a25-owner-package-authorizations=dry-run-blocked-owner-approval-placeholders; record-a22-root-parity-owner-input=already-recorded; record-validation-hold-confirmation=dry-run-ready-requires-explicit-apply
