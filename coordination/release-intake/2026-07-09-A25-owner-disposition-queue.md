# 2026-07-09 A25 Owner Disposition Queue

Generated: 2026-07-09T14:10:16.466Z

Dirty map: `coordination/release-intake/latest-A25-dirty-tree-map.json`

Expanded status entries: 6604

Status signature: `b3d232fd2b9ef81d4efc95903d2e3b316db664d6e9ec6ab366181395b3966be7`
...
| P3 | A10 tooling, docs, and report | 482 | docs/coordination evidence: 476 | `coordination/release-intake/latest-A25-owner-a10-tooling-docs-and-report.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Shared coordination/config surface. |
...
| P3 | A18 curriculum QA / A21 content pipeline | 30 | docs/coordination evidence: 28 | `coordination/release-intake/latest-A25-owner-a18-curriculum-qa-a21-content-pipeline.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Content QA and generation pipeline must stay separated. |
| P3 | Unmapped/manual owner needed | 2 | unmapped/manual: 2 | `coordination/release-intake/latest-A25-owner-unmapped-manual-owner-needed.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Manual classification required. |
| P4 | A05 lesson lead | 128 | runtime app/API/data/public: 116 | `coordination/release-intake/latest-A25-owner-a05-lesson-lead.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Standard owner review package. |
| P4 | A04 practice lead | 59 | runtime app/API/data/public: 48 | `coordination/release-intake/latest-A25-owner-a04-practice-lead.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Standard owner review package. |
...
| P4 | A24 illustration exact-layer | 6 | runtime app/API/data/public: 6 | `coordination/release-intake/latest-A25-owner-a24-illustration-exact-layer.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Standard owner review package. |
