...
Generated: 2026-07-10T17:08:37.363Z
...
- Owner package entries: 7636
- Executable rows now: 0
- Cleanup-authorized rows now: 0

| Wave | Wave ID | Name | Owner approvals | Physical approvals | Owner entries |
| ---: | --- | --- | ---: | ---: | ---: |
| 1 | `wave-01-governance-release-hygiene` | A25/A10/A22 governance and release hygiene | 4 | 7 | 6267 |
| 2 | `wave-02-shared-contracts` | A08/A12 shared contracts and storage/API stability | 2 | 4 | 189 |
| 3 | `wave-03-shell-dashboard-roadmap` | A01/A02/A03/A15 student shell, dashboard, and roadmap | 4 | 4 | 92 |
| 4 | `wave-04-practice-lesson-content` | A04/A05/A18/A21/A23/A24 practice, lesson, and content evidence | 7 | 7 | 481 |
| 5 | `wave-05-visualization-ai-runtime` | A06/A07/A09/A11/A13/A14/A16/A17/A20 runtime and QA surfaces | 9 | 12 | 607 |
...
| --- | --- | ---: | ---: |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 5702 |
| `a22-production-reliability-and-release-engineering` | A22 production reliability and release engineering | P1 | 68 |
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 490 |
| `manual-a10-a25-owner-assignment-required` | Manual A10/A25 owner assignment required | P4 | 7 |
...
| `codex-a22-missing-module-release-slice` | `codex/A22-missing-module-release-slice` | dirty-open-decision | dirty 1017 |
...
| `a12-backend-api-platform` | A12 backend/API platform | P2 | 178 |

### Physical Lifecycle Approvals

| Approval ID | Branch | State | Current blocker |
| --- | --- | --- | --- |
| `codex-a08-a12-shared-contract-closure` | `codex/A08-A12-shared-contract-closure` | dirty-open-decision | dirty 186 |
...
| Approval ID | Owner | Priority | Entries |
| --- | --- | ---: | ---: |
| `a04-practice-lead` | A04 practice lead | P3 | 60 |
| `a05-lesson-lead` | A05 lesson lead | P3 | 129 |
| `a18-curriculum-qa-a21-content-pipeline` | A18 curriculum QA / A21 content pipeline | P3 | 45 |
| `a18-curriculum-qa-and-content-quality-lead` | A18 curriculum QA and content quality lead | P4 | 1 |
| `a21-content-pipeline-and-rag-operations` | A21 content pipeline and RAG operations | P3 | 76 |
| `a23-integration-and-promotion-lead` | A23 integration and promotion lead | P4 | 2 |
| `a24-illustration-exact-layer` | A24 illustration exact-layer | P4 | 168 |
...
| `a11-qa-and-release-quality` | A11 QA and release quality | P2 | 64 |
| `a13-teacher-console` | A13 teacher console | P4 | 37 |
...
| Approval ID | Branch | State | Current blocker |
| --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 7636 |
