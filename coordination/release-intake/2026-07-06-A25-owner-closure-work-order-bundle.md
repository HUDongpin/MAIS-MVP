...
Generated: 2026-07-06T15:50:23.124Z
...
- Authorization starters: 84
- A22 generated-artifact residual authorizations: 0
- Next-owner focus batch status: waiting-for-owner-authorization
- Next-owner focus batch rows: 3
- Next-owner focus batch accepted rows: 0
- Next-owner focus batch pending rows: 3
- Next-owner focus batch held rows: 1
- Next-owner focus batch owner-input visible rows: 3
- Next-owner focus batch canonical draft visible rows: 3
...
- Next-owner focus batch recording pending rows: 3
- Next-owner focus batch recording owner-input visible rows: 3
...
Recording pending rows: 3

Recording failed checks: 0

| Agent | Owner | Focus rows | Work order |
| --- | --- | ---: | --- |
| A09 | A09 copy, i18n, accessibility | 1 | `coordination/release-intake/latest-A25-owner-closure-work-order-a09.md` |
| A17 | A17 gamification and motivation | 1 | `coordination/release-intake/latest-A25-owner-closure-work-order-a17.md` |
| A23 | A23 integration and promotion lead | 1 | `coordination/release-intake/latest-A25-owner-closure-work-order-a23.md` |
...
| A09 | A09 copy, i18n, accessibility | 2 | 0 | 0 | 0 | 0 | 2 | 0 | 1 | 0 | `coordination/release-intake/latest-A25-owner-closure-work-order-a09.md` |
...
| A17 | A17 gamification and motivation | 2 | 0 | 0 | 0 | 0 | 2 | 0 | 1 | 0 | `coordination/release-intake/latest-A25-owner-closure-work-order-a17.md` |
...
| A22 | A22 production reliability and release engineering | 16 | 0 | 0 | 0 | 0 | 12 | 0 | 0 | 4 | `coordination/release-intake/latest-A25-owner-closure-work-order-a22.md` |
| A23 | A23 integration and promotion lead | 2 | 0 | 0 | 0 | 0 | 1 | 0 | 1 | 1 | `coordination/release-intake/latest-A25-owner-closure-work-order-a23.md` |
...
| A25 | A25 git hygiene and release intake lead | 10 | 1 | 1 | 1 | 0 | 5 | 0 | 0 | 4 | `coordination/release-intake/latest-A25-owner-closure-work-order-a25.md` |
