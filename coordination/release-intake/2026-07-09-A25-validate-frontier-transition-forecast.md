...
Generated: 2026-07-09T12:41:18.985Z
...
| --- | --- | --- | ---: | --- |
| `canonical-authorization-backlog` | still-blocked | owner-input | 41 | 41 canonical authorization row(s) would remain after the current A25 focus rows. |
...
| `a25-transition-projection-current` | pass | pending=41; projectedPending=41; projectedValid=26 |
