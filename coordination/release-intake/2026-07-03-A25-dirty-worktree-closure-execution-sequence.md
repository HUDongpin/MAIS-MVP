...
Generated: 2026-07-03T08:30:38.984Z
...
| 4 | `wave-04-practice-lesson-content` | A04/A05/A18/A21/A23/A24 practice, lesson, and content evidence | 6 | 7 | 408 |
| 5 | `wave-05-visualization-ai-runtime` | A06/A07/A09/A11/A13/A14/A16/A17/A20 runtime and QA surfaces | 9 | 11 | 594 |
...
| --- | --- | ---: | ---: |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 2233 |
| `a22-production-reliability-and-release-engineering` | A22 production reliability and release engineering | P1 | 68 |
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 442 |

### Physical Lifecycle Approvals

| Approval ID | Branch | State | Current blocker |
| --- | --- | --- | --- |
| `codex-a25-dirty-closure-governance` | `codex/A25-dirty-closure-governance` | dirty-open-decision | dirty 1018 |
| `codex-a10-a22-release-governance` | `codex/A10-A22-release-governance` | clean-diverged-open-decision | behind 1, ahead 2 |
...
| `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | clean-diverged-open-decision | behind 1, ahead 1 |
...
| Approval ID | Owner | Priority | Entries |
| --- | --- | ---: | ---: |
| `a04-practice-lead` | A04 practice lead | P3 | 58 |
| `a05-lesson-lead` | A05 lesson lead | P3 | 128 |
| `a18-curriculum-qa-a21-content-pipeline` | A18 curriculum QA / A21 content pipeline | P3 | 138 |
...
| `a24-illustration-exact-layer` | A24 illustration exact-layer | P4 | 8 |

### Physical Lifecycle Approvals

| Approval ID | Branch | State | Current blocker |
| --- | --- | --- | --- |
| `codex-california-practice-beta-clean` | `codex/california-practice-beta-clean` | clean-diverged-open-decision | behind 13, ahead 1 |
| `codex-a04-practice-closure` | `codex/A04-practice-closure` | dirty-open-decision | dirty 56 |
| `codex-a05-lesson-checklist-p0` | `codex/A05-lesson-checklist-p0` | clean-diverged-open-decision | behind 1, ahead 0 |
| `codex-a05-lesson-closure` | `codex/A05-lesson-closure` | dirty-open-decision | dirty 126 |
| `codex-a05-lesson-pep-load` | `codex/A05-lesson-pep-load` | clean-diverged-open-decision | behind 1, ahead 0 |
| `codex-a05-next-item-button-scroll` | `codex/A05-next-item-button-scroll` | clean-diverged-open-decision | behind 1, ahead 0 |
...
| Approval ID | Owner | Priority | Entries |
| --- | --- | ---: | ---: |
| `a06-visualization-lead` | A06 visualization lead | P2 | 445 |
...
| `a16-research-and-learning-science` | A16 research and learning science | P4 | 6 |
...
| Approval ID | Branch | State | Current blocker |
| --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 4023 |
...
| `codex-a19-vercel-postgres-region` | `codex/A19-vercel-postgres-region` | clean-diverged-open-decision | behind 1, ahead 8 |
| `codex-s22-release-hygiene-2026-06-15` | `codex/s22-release-hygiene-2026-06-15` | clean-diverged-open-decision | behind 13, ahead 1 |
