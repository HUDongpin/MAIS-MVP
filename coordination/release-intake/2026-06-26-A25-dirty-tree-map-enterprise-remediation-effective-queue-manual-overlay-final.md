...
Generated at: 2026-06-26T10:21:13.976Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 effective queue manual overlay final inventory
Status signature: `0104b98f6f0e94ba2f6e3ef947de675c51836a6b9c3996408bdc25fdafaa1257`

## Counts

- Collapsed status entries: 959
- Expanded status entries: 1563
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 593
- Untracked files: 1197

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 391 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 689 |
