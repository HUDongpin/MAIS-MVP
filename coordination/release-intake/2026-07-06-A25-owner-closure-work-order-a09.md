# A25 Owner Closure Work Order - A09
...
| --- | --- | --- | --- | --- | --- |
| a09-copy-i18n-accessibility | owner-package | coordination/release-intake/latest-A25-effective-owner-a09-copy-i18n-accessibility.pathspec | owner-selected-final-state | no | no |
| codex-a09-copy-i18n-accessibility-closure | physical-lifecycle | codex/A09-copy-i18n-accessibility-closure | owner-selected-lifecycle-final-state | no | no |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| a09-copy-i18n-accessibility | yes | no | no | waiting-for-owner-authorization | canonical row is missing | no | no |
