# A25 Owner Closure Work Order - A08
...
| --- | --- | --- | --- | --- | --- |
| a08-state-and-analytics-lead | owner-package | coordination/release-intake/latest-A25-effective-owner-a08-state-and-analytics-lead.pathspec | owner-selected-final-state | no | no |
