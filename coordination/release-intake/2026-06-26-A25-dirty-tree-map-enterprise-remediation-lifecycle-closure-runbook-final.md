...
Generated at: 2026-06-26T10:47:44.574Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 lifecycle closure runbook inventory
Status signature: `2e93fc286560443faeb253ca7d62c71a093835b6b87a0e054e976b572ca34ca7`

## Counts

- Collapsed status entries: 961
- Expanded status entries: 1613
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 595
- Untracked files: 1247

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 439 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 737 |
