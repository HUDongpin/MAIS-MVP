...
Generated at: 2026-06-30T07:15:25.773Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 dirty-worktree closure baseline
Status signature: `a35eff5ea1c61bb01f52fd4cde4fda6072353125ebdf6066a96313b9a693226e`

## Counts

- Collapsed status entries: 1208
- Expanded status entries: 2051
- Tracked modified: 385
- Tracked deleted: 1
- Untracked status entries: 822
- Untracked files: 1665

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 618 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 993 |
