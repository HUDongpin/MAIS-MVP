...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 1768 | root package has 1768 dirty entries |
| `a22-production-reliability-and-release-engineering` | A22 production reliability and release engineering | P1 | 67 | root package has 67 dirty entries |
...
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 395 | root package has 395 dirty entries |
...
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 3505 | A25, A10, A22, effective file owners |
