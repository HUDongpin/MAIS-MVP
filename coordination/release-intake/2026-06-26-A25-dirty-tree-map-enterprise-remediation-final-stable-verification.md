...
Generated at: 2026-06-26T10:34:15.900Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 final stable verification inventory
Status signature: `ee904330019672a3e831a891d9de98de0f911082e0624633a339d0b2ec8a2fb6`

## Counts

- Collapsed status entries: 961
- Expanded status entries: 1578
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 595
- Untracked files: 1212

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 404 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 702 |
