...
Generated at: 2026-06-27T17:59:52.886Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-ui-loading-smoke-final-2026-06-28
Status signature: `8ea3bd8f4400a197e43725c1905219f47ca2618087b8a041bd637e81cb146627`

## Counts

- Collapsed status entries: 1083
- Expanded status entries: 1844
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 700
- Untracked files: 1461

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 537 |
| A06 visualization lead | 350 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 879 |
