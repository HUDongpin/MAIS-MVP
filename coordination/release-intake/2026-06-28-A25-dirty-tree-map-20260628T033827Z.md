...
Generated at: 2026-06-28T03:38:32.185Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-release-build-gate-2026-06-28
Status signature: `266ed91a48fa268398f6ac78620950e2686633f06ddcd2fea651fadf5625ad1d`

## Counts

- Collapsed status entries: 1096
- Expanded status entries: 1899
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 713
- Untracked files: 1516

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 579 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 924 |
