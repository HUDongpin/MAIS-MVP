...
Generated at: 2026-06-26T10:29:36.371Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 lifecycle decision ledger current gate inventory
Status signature: `922422cad5eeae7f4fe30a8393a50cb10e94551c4051c4a18d72e18ceb36fcbe`

## Counts

- Collapsed status entries: 959
- Expanded status entries: 1574
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 593
- Untracked files: 1208

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 402 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 700 |
