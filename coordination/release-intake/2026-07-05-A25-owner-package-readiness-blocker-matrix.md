...
Generated: 2026-07-05T11:15:23.488Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `wave-01-governance-release-hygiene` | `wave-01-governance-release-hygiene` | A25 git hygiene and release intake, A22 production reliability and release engineering, A10 tooling, docs, and report | blocked | 1018 | 3 | 404 | 7 |
...
- Wave01 frontier: waiting-for-owner-execution-instruction; artifact-clean authorized=6; held=1; valid execution instructions=0
- Wave01 frontier evidence: `coordination/release-intake/latest-A25-wave01-package-resync-owner-authorizations-current-gate.json,coordination/release-intake/latest-A25-wave01-a25-artifact-clean-owner-approval-capsule.json,coordination/release-intake/latest-A25-wave01-package-resync-owner-acceptance-docket.json`
- Failed checks: highAudit, releaseHelperTests, typeCheck
- Type-check error lines: 404
- Blocking reasons: 1 held package-resync row remains: wave01-resync-01-tsconfig-json; 6 owner-authorized Wave01 artifact-clean row(s) still need separate execution instruction; npm audit --audit-level=high failed or unavailable; release helper tests failed; npm run type-check failed
- Pathspecs:
