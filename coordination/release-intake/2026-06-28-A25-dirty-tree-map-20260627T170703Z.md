...
Generated at: 2026-06-27T17:07:07.760Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-preview-smoke-gate-2026-06-28
Status signature: `514f5c58c453d1faf14b1f3806867ce91efd14b25545140f65c4b29adbc2365d`

## Counts

- Collapsed status entries: 1077
- Expanded status entries: 1820
- Tracked modified: 381
- Tracked deleted: 1
- Untracked status entries: 695
- Untracked files: 1438

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 520 |
...
| A22 production reliability and release engineering | 30 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 860 |
