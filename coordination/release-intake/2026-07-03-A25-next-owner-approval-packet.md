...
Generated: 2026-07-03T08:38:56.819Z
...
| 3 | physical-lifecycle-approvals | 37 | Linked worktrees and diverged branches need explicit lifecycle final-state choices before strict lifecycle can pass. |
...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 2233 | root package has 2233 dirty entries |
...
| `a06-visualization-lead` | A06 visualization lead | P2 | 445 | root package has 445 dirty entries |
...
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 442 | root package has 442 dirty entries |
...
| `a04-practice-lead` | A04 practice lead | P3 | 58 | root package has 58 dirty entries |
...
Showing first 12 of 37.

| Approval ID | Branch | State | Current blocker | Owner hints |
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 4023 | A25, A10, A22, effective file owners |
...
| `codex-a05-lesson-checklist-p0` | `codex/A05-lesson-checklist-p0` | clean-diverged-open-decision | behind 1, ahead 0 | A05 |
| `codex-a05-lesson-closure` | `codex/A05-lesson-closure` | dirty-open-decision | dirty 126 | A05 |
| `codex-a05-lesson-pep-load` | `codex/A05-lesson-pep-load` | clean-diverged-open-decision | behind 1, ahead 0 | A05 |
| `codex-a05-next-item-button-scroll` | `codex/A05-next-item-button-scroll` | clean-diverged-open-decision | behind 1, ahead 0 | A05 |
...
| 5 | wave-05-visualization-ai-runtime | 9 | 11 | Owner authorizes every selected final state and exact Git operation needed for this wave. |
