...
Generated: 2026-07-05T11:12:22.802Z
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 3030 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 459 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 4737 | A25, A10, A22, effective file owners |
...
| 32 | `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | clean-diverged-branch | behind 2, ahead 1 | A22 |
| 33 | `codex-a25-ci-backup-workflow` | `codex/A25-ci-backup-workflow` | clean-diverged-branch | behind 1, ahead 0 | A25 |
| 34 | `codex-a25-dirty-closure-governance` | `codex/A25-dirty-closure-governance` | dirty-diverged-worktree | dirty 1018 | A25 |
