...
Generated: 2026-07-08T12:21:18.161Z
...
| `dirty-map-current` | pass | dirtyMapEntries=6116; previewEntries=6116 |
| `selected-action-preview-current` | pass | previewStatus=owner-approved-waiting-candidate-mutation; previewRows=4; pendingRows=0 |
...
| `post-owner-input-chain-still-blocked` | pass | intake=ready-to-record-extraction-instruction-rows; recorder=already-recorded; executor=dry-run-ready-requires-explicit-apply |
