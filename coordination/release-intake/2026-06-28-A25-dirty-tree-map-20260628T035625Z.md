...
Generated at: 2026-06-28T03:56:32.904Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-auth-precheck-order-final-report-currentness-2026-06-28
Status signature: `fed540a0216fdb772292f2e4e7b13bff59258c58261402c71f3259e40f0e324f`

## Counts

- Collapsed status entries: 1097
- Expanded status entries: 1908
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 714
- Untracked files: 1525

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 587 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 933 |
