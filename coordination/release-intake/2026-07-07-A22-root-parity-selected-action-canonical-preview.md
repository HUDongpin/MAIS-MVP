...
Generated: 2026-07-07T15:08:04.952Z
...
- Top candidate queue action: `needs-root-parity-owner-input-before-rerun`
- Preview rows: 4
- Accepted rows: 0
- Pending rows: 4
...
| `top-validation-queue-waits-owner-input` | pass | queueStatus=waiting-top-candidate-root-parity-owner-input; topAction=needs-root-parity-owner-input-before-rerun |
| `owner-action-packet-waiting` | pass | focusStatus=waiting-for-owner-action; focusRows=4 |
| `acceptance-docket-waiting` | pass | acceptanceStatus=waiting-for-owner-action; acceptedRows=0 |
| `owner-input-still-blank` | pass | owner input file must remain blank before explicit owner approval |
