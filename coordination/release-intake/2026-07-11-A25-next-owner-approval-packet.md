...
Generated: 2026-07-10T17:12:00.836Z
...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 5702 | root package has 5702 dirty entries |
...
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 7636 | A25, A10, A22, effective file owners |
