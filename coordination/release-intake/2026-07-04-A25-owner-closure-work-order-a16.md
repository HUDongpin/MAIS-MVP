# A25 Owner Closure Work Order - A16
...
| --- | --- | --- | --- | --- | --- |
| a16-research-and-learning-science | owner-package | coordination/release-intake/latest-A25-effective-owner-a16-research-and-learning-science.pathspec | owner-selected-final-state | no | no |
| codex-a16-research-evidence-closure | physical-lifecycle | codex/A16-research-evidence-closure | owner-selected-lifecycle-final-state | no | no |
