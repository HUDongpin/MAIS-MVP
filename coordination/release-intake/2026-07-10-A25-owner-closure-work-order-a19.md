# A25 Owner Closure Work Order - A19
...
| --- | --- | --- | --- | --- | --- |
| codex-a19-vercel-postgres-region | physical-lifecycle | codex/A19-vercel-postgres-region | owner-selected-lifecycle-final-state | no | no |
