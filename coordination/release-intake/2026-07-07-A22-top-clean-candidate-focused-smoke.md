...
Generated: 2026-07-07T15:07:41.422Z
...
- Pass: 2
- Fail: 0
- Worktree status entries before smoke: 0
- Worktree status entries after smoke: 0
...
| `focused-smoke-no-mutation` | A25 git hygiene and release intake | passed | yes | Candidate worktree status stayed clean before/after smoke; mutationDetected=false. |
