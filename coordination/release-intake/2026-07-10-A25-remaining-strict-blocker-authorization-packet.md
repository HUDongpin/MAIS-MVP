...
Generated: 2026-07-10T15:56:14.061Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 7221 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
