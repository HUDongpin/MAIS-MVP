...
Generated: 2026-07-10T15:58:35.519Z
...
| --- | --- | --- | --- | ---: | --- |
| `current-root-clean-worktree` | clean worktree | blocked | no | 3 | 7221 root dirty status entries remain in integration inventory; dirty-root deploy guard is expected to block direct preview/production publish; A22 policy requires a clean worktree, clean clone, reviewed clean release slice, or owner-approved pruned staging package |
...
| --- | --- | --- | ---: | --- |
| `a22-release-source-not-clean` | A22 production reliability and release engineering | blocked | 7221 | The current root remains a dirty integration inventory and cannot be used as the release source. |
