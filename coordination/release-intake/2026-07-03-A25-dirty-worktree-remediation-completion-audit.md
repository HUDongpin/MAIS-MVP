...
Generated: 2026-07-03T10:00:55.848Z
...
| owner-pathspecs-current | incomplete | 1 | A25 owner pathspecs are current |
| effective-owner-overlay-current | incomplete | 1 | A25 effective owner overlay is current |
...
| lifecycle-decision-requests-current | incomplete | 1 | A25 lifecycle decision requests are current |
| owner-approval-matrix-current | incomplete | 1 | A25 owner approval matrix is current |
| lifecycle-closure-runbook-current | incomplete | 1 | A25 lifecycle closure runbook is current |
| final-state-recorded | incomplete | 1 | Every dirty package/lifecycle row has a recorded final state |
...
| --- | --- | --- | --- |
| task-1-governance | incomplete | Task 1 governance artifacts | A25 owner pathspecs are current; A25 effective owner overlay is current; A25 lifecycle decision requests are current |
