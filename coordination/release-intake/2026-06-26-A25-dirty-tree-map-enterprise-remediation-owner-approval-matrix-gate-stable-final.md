...
Generated at: 2026-06-26T10:58:12.234Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 owner approval matrix gate stable inventory
Status signature: `ae66da738b44e700a487f045816e5f9f27d1e5f08870565c4e3967bd103ac45c`

## Counts

- Collapsed status entries: 961
- Expanded status entries: 1631
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 595
- Untracked files: 1265

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 457 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 755 |
