# A25 Owner Closure Work Order - A05
...
| --- | --- | --- | --- | --- | --- |
| a05-lesson-lead | owner-package | coordination/release-intake/latest-A25-effective-owner-a05-lesson-lead.pathspec | owner-selected-final-state | no | no |
| codex-a05-lesson-checklist-p0 | physical-lifecycle | codex/A05-lesson-checklist-p0 | owner-selected-lifecycle-final-state | no | no |
| codex-a05-lesson-closure | physical-lifecycle | codex/A05-lesson-closure | owner-selected-lifecycle-final-state | no | no |
| codex-a05-lesson-pep-load | physical-lifecycle | codex/A05-lesson-pep-load | owner-selected-lifecycle-final-state | no | no |
| codex-a05-next-item-button-scroll | physical-lifecycle | codex/A05-next-item-button-scroll | owner-selected-lifecycle-final-state | no | no |
