...
Generated: 2026-07-08T14:12:53.564Z
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 4404 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 478 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 6130 | A25, A10, A22, effective file owners |
...
| 32 | `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | dirty-diverged-worktree | dirty 4 | A22 |
