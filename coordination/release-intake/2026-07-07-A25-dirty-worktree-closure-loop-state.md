...
Generated: 2026-07-07T15:31:27.099Z
...
- Focus batch owner-authorization intake: ready-for-post-input-validation
- Focus batch accepted rows: 3/3
- Focus batch pending rows: 0
- Focus batch owner-input visible rows: 3
...
- Exact command targets ready: 1/1
...
| 合并 | merge | blocked | 1/4 | 39 canonical authorization row(s) are still pending; Owner inputs are not ready; Validation hold is waiting for owner compose deletion confirmation |
| 清理 | cleanup | blocked | 0/4 | 5717 expanded dirty entries remain; A22 release source is not clean; A25 strict worktree lifecycle is not clean |
...
| Check | Passed | Blocker |
| --- | --- | --- |
| Owner canonical authorization rows are recorded | no | 39 canonical authorization row(s) are still pending |
...
| Check | Passed | Blocker |
| --- | --- | --- |
| Root dirty entries are zero | no | 5717 expanded dirty entries remain |
