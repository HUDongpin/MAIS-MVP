...
Generated: 2026-07-10T17:12:24.398Z
...
| unmapped-runtime-zero | incomplete | 1 | A25 unmapped runtime proposals are current with zero unmapped runtime paths |
| unmapped-manual-zero | incomplete | 1 | A25 unmapped manual proposals are current with zero unmapped manual paths |
...
| task-2-unmapped | incomplete | Task 2 unmapped ownership | A25 unmapped runtime proposals are current with zero unmapped runtime paths; A25 unmapped manual proposals are current with zero unmapped manual paths |
| task-3-wave01 | incomplete | Task 3 governance/release-hygiene package closure | 6 A25 artifact-clean row(s) still need owner authorization; npm run type-check failed |
| task-4-wave02 | incomplete | Task 4 shared contract/backend package closure | 1 dirty entries are outside the A08/A12 pathspec union; testAnalytics failed; testBackend failed |
