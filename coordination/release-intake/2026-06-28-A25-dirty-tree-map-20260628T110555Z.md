...
Generated at: 2026-06-28T11:06:00.158Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A22 production deployment of latest local version to www.mais.ac and www.mais.hk
Status signature: `ff934a1b2f3b3bdf55f2d94c67194e0b3f88b69fa27e4148a777f1ee95a68caf`

## Counts

- Collapsed status entries: 1172
- Expanded status entries: 1994
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 789
- Untracked files: 1611

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 597 |
| A06 visualization lead | 417 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 955 |
| runtime app/API/data/public | 580 |
| tests/regression evidence | 361 |
