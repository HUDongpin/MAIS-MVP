...
Generated: 2026-07-01T15:44:43.317Z
...
- Owner package approval IDs: 24
- Physical lifecycle approval IDs: 33
- Total approval IDs: 57
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 1381 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
| 2 | `a22-production-reliability-and-release-engineering` | A22 production reliability and release engineering | P1 | 44 | `coordination/release-intake/latest-A25-effective-owner-a22-production-reliability-and-release-engineering.pathspec` |
| 3 | `a06-visualization-lead` | A06 visualization lead | P2 | 443 | `coordination/release-intake/latest-A25-effective-owner-a06-visualization-lead.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 225 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
| 7 | `a18-curriculum-qa-a21-content-pipeline` | A18 curriculum QA / A21 content pipeline | P3 | 138 | `coordination/release-intake/latest-A25-effective-owner-a18-curriculum-qa-a21-content-pipeline.pathspec` |
| 8 | `a05-lesson-lead` | A05 lesson lead | P3 | 126 | `coordination/release-intake/latest-A25-effective-owner-a05-lesson-lead.pathspec` |
| 9 | `a21-content-pipeline-and-rag-operations` | A21 content pipeline and RAG operations | P3 | 74 | `coordination/release-intake/latest-A25-effective-owner-a21-content-pipeline-and-rag-operations.pathspec` |
| 10 | `a04-practice-lead` | A04 practice lead | P3 | 56 | `coordination/release-intake/latest-A25-effective-owner-a04-practice-lead.pathspec` |
| 11 | `a03-curriculum-roadmap-lead` | A03 curriculum roadmap lead | P3 | 30 | `coordination/release-intake/latest-A25-effective-owner-a03-curriculum-roadmap-lead.pathspec` |
...
| 14 | `a02-dashboard-lead` | A02 dashboard lead | P4 | 21 | `coordination/release-intake/latest-A25-effective-owner-a02-dashboard-lead.pathspec` |
...
| 19 | `a24-illustration-exact-layer` | A24 illustration exact-layer | P4 | 8 | `coordination/release-intake/latest-A25-effective-owner-a24-illustration-exact-layer.pathspec` |
| 20 | `a14-parent-console` | A14 parent console | P4 | 7 | `coordination/release-intake/latest-A25-effective-owner-a14-parent-console.pathspec` |
| 21 | `a16-research-and-learning-science` | A16 research and learning science | P4 | 6 | `coordination/release-intake/latest-A25-effective-owner-a16-research-and-learning-science.pathspec` |
| 22 | `a09-copy-i18n-accessibility` | A09 copy, i18n, accessibility | P4 | 5 | `coordination/release-intake/latest-A25-effective-owner-a09-copy-i18n-accessibility.pathspec` |
| 23 | `a17-gamification-and-motivation` | A17 gamification and motivation | P4 | 5 | `coordination/release-intake/latest-A25-effective-owner-a17-gamification-and-motivation.pathspec` |
| 24 | `a23-integration-and-promotion-lead` | A23 integration and promotion lead | P4 | 2 | `coordination/release-intake/latest-A25-effective-owner-a23-integration-and-promotion-lead.pathspec` |

## Physical Lifecycle Queue

| Order | Approval ID | Branch | Kind | Current blocker | Owner hints |
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 2923 | A25, A10, A22, effective file owners |
| 2 | `codex-a01-app-shell-closure` | `codex/A01-app-shell-closure` | dirty-linked-worktree | dirty 26 | A01 |
| 3 | `codex-a01-shell-lazy-load` | `codex/A01-shell-lazy-load` | dirty-linked-worktree | dirty 8 | A01 |
| 4 | `codex-a02-a15-dashboard-adaptive-closure` | `codex/A02-A15-dashboard-adaptive-closure` | dirty-linked-worktree | dirty 30 | A02, A15 |
| 5 | `codex-a03-roadmap-closure` | `codex/A03-roadmap-closure` | dirty-linked-worktree | dirty 30 | A03 |
| 6 | `codex-a04-practice-closure` | `codex/A04-practice-closure` | dirty-linked-worktree | dirty 56 | A04 |
| 7 | `codex-a05-lesson-closure` | `codex/A05-lesson-closure` | dirty-linked-worktree | dirty 126 | A05 |
| 8 | `codex-a06-manim-three-closure` | `codex/A06-manim-three-closure` | dirty-linked-worktree | dirty 351 | A06 |
| 9 | `codex-a06-visualization-closure` | `codex/A06-visualization-closure` | dirty-linked-worktree | dirty 437 | A06, A22 |
| 10 | `codex-a07-a15-a08-ai-adaptive-types` | `codex/A07-A15-A08-ai-adaptive-types` | dirty-linked-worktree | dirty 30 | A07, A08, A15 |
| 11 | `codex-a07-ai-tutor-classroom-switches` | `codex/A07-ai-tutor-classroom-switches` | dirty-linked-worktree | dirty 82 | A07 |
| 12 | `codex-a07-ai-tutor-closure` | `codex/A07-ai-tutor-closure` | dirty-linked-worktree | dirty 12 | A07 |
| 13 | `codex-a08-a12-shared-contract-closure` | `codex/A08-A12-shared-contract-closure` | dirty-linked-worktree | dirty 185 | A08, A12 |
| 14 | `codex-a09-copy-i18n-accessibility-closure` | `codex/A09-copy-i18n-accessibility-closure` | dirty-linked-worktree | dirty 5 | A09 |
| 15 | `codex-a10-a22-a08-a12-a06-compose-20260628` | `codex/A10-A22-A08-A12-A06-compose-20260628` | dirty-diverged-worktree | dirty 744 | A06, A08, A10, A12, A22 |
| 16 | `codex-a10-a22-release-governance` | `codex/A10-A22-release-governance` | clean-diverged-branch | behind 0, ahead 2 | A10, A22 |
| 17 | `codex-a11-regression-evidence-closure` | `codex/A11-regression-evidence-closure` | dirty-linked-worktree | dirty 62 | A11 |
| 18 | `codex-a12-google-oauth-login` | `codex/A12-google-oauth-login` | dirty-linked-worktree | dirty 16 | A12 |
| 19 | `codex-a12-userstore-storage-contract` | `codex/A12-userstore-storage-contract` | dirty-linked-worktree | dirty 170 | A12 |
| 20 | `codex-a13-a14-console-closure` | `codex/A13-A14-console-closure` | dirty-linked-worktree | dirty 43 | A13, A14 |
| 21 | `codex-a16-research-evidence-closure` | `codex/A16-research-evidence-closure` | dirty-linked-worktree | dirty 6 | A16 |
| 22 | `codex-a17-a20-game-motivation-closure` | `codex/A17-A20-game-motivation-closure` | dirty-linked-worktree | dirty 21 | A17, A20 |
| 23 | `codex-a18-a21-content-evidence-closure` | `codex/A18-A21-content-evidence-closure` | dirty-linked-worktree | dirty 222 | A18, A21 |
| 24 | `codex-a19-vercel-postgres-region` | `codex/A19-vercel-postgres-region` | clean-diverged-branch | behind 0, ahead 8 | A19 |
| 25 | `codex-a22-missing-module-release-slice` | `codex/A22-missing-module-release-slice` | dirty-linked-worktree | dirty 1016 | A22 |
| 26 | `codex-a22-next-15-5-19-audit` | `codex/A22-next-15-5-19-audit` | dirty-linked-worktree | dirty 4 | A22 |
| 27 | `codex-a22-p1-release-hygiene-security` | `codex/A22-p1-release-hygiene-security` | dirty-linked-worktree | dirty 27 | A22 |
| 28 | `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | clean-diverged-branch | behind 0, ahead 1 | A22 |
| 29 | `codex-a25-dirty-closure-governance` | `codex/A25-dirty-closure-governance` | dirty-linked-worktree | dirty 1018 | A25 |
| 30 | `codex-a25-full-dirty-compose-verification` | `codex/A25-full-dirty-compose-verification` | dirty-linked-worktree | dirty 2423 | A25 |
| 31 | `codex-visualization-production-release` | `codex/visualization-production-release` | dirty-diverged-worktree | dirty 16 | A06, A22 |
| 32 | `codex-california-practice-beta-clean` | `codex/california-practice-beta-clean` | clean-diverged-branch | behind 12, ahead 1 | A21, A18, A04, A22 |
| 33 | `codex-s22-release-hygiene-2026-06-15` | `codex/s22-release-hygiene-2026-06-15` | clean-diverged-branch | behind 12, ahead 1 | A22, A10 |
...
```text
Authorize approvalId=codex-a06-manim-three-closure for branch=codex/A06-manim-three-closure; selectedFinalState=<one allowed final state in the physical lifecycle request>; evidenceReviewed=coordination/release-intake/archive/2026-06-30-A25-linked-worktree-archive-manifest.md, coordination/release-intake/archive/codex-A06-manim-three-closure.status.txt, coordination/release-intake/archive/codex-A06-manim-three-closure.diffstat.txt, coordination/release-intake/archive/codex-A06-manim-three-closure.patch, coordination/release-intake/archive/codex-A06-manim-three-closure.untracked.txt; approvedBy=<owner>; approvedAt=<ISO-8601>; notes=<scope, exact paths if discard/removal, and checks>.
```
