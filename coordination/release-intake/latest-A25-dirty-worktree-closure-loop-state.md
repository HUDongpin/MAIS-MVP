...
Generated: 2026-07-10T17:12:26.811Z
...
- Exact command targets ready: 2/2
...
| 合并 | merge | blocked | 1/4 | 40 canonical authorization row(s) are still pending; Owner inputs are not ready; Validation hold is waiting for owner compose deletion confirmation |
| 清理 | cleanup | blocked | 0/4 | 7636 expanded dirty entries remain; A22 release source is not clean; A25 strict worktree lifecycle is not clean |
...
| Check | Passed | Blocker |
| --- | --- | --- |
| Owner canonical authorization rows are recorded | no | 40 canonical authorization row(s) are still pending |
...
| Check | Passed | Blocker |
| --- | --- | --- |
| Root dirty entries are zero | no | 7636 expanded dirty entries remain |
