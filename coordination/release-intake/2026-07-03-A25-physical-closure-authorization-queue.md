...
Generated: 2026-07-03T08:30:28.347Z
...
- Physical lifecycle approval IDs: 37
- Total approval IDs: 61
...
| ---: | --- | --- | ---: | ---: | --- |
| 1 | `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 2233 | `coordination/release-intake/latest-A25-effective-owner-a25-git-hygiene-and-release-intake.pathspec` |
...
| 6 | `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 442 | `coordination/release-intake/latest-A25-effective-owner-a10-tooling-docs-and-report.pathspec` |
...
| 8 | `a05-lesson-lead` | A05 lesson lead | P3 | 128 | `coordination/release-intake/latest-A25-effective-owner-a05-lesson-lead.pathspec` |
...
| 10 | `a04-practice-lead` | A04 practice lead | P3 | 58 | `coordination/release-intake/latest-A25-effective-owner-a04-practice-lead.pathspec` |
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `root-main` | `main` | root-owner-package | dirty 4023 | A25, A10, A22, effective file owners |
...
| 7 | `codex-a05-lesson-checklist-p0` | `codex/A05-lesson-checklist-p0` | clean-diverged-branch | behind 1, ahead 0 | A05 |
| 8 | `codex-a05-lesson-closure` | `codex/A05-lesson-closure` | dirty-diverged-worktree | dirty 126 | A05 |
| 9 | `codex-a05-lesson-pep-load` | `codex/A05-lesson-pep-load` | clean-diverged-branch | behind 1, ahead 0 | A05 |
| 10 | `codex-a05-next-item-button-scroll` | `codex/A05-next-item-button-scroll` | clean-diverged-branch | behind 1, ahead 0 | A05 |
...
| 18 | `codex-a10-a22-a08-a12-a06-compose-20260628` | `codex/A10-A22-A08-A12-A06-compose-20260628` | dirty-diverged-worktree | dirty 744 | A06, A08, A10, A12, A22 |
| 19 | `codex-a10-a22-release-governance` | `codex/A10-A22-release-governance` | clean-diverged-branch | behind 1, ahead 2 | A10, A22 |
...
| 28 | `codex-a19-vercel-postgres-region` | `codex/A19-vercel-postgres-region` | clean-diverged-branch | behind 1, ahead 8 | A19 |
...
| 32 | `codex-a22-us-region-alignment` | `codex/A22-us-region-alignment` | clean-diverged-branch | behind 1, ahead 1 | A22 |
| 33 | `codex-a25-dirty-closure-governance` | `codex/A25-dirty-closure-governance` | dirty-diverged-worktree | dirty 1018 | A25 |
| 34 | `codex-a25-full-dirty-compose-verification` | `codex/A25-full-dirty-compose-verification` | dirty-diverged-worktree | dirty 2423 | A25 |
| 35 | `codex-visualization-production-release` | `codex/visualization-production-release` | dirty-diverged-worktree | dirty 16 | A06, A22 |
| 36 | `codex-california-practice-beta-clean` | `codex/california-practice-beta-clean` | clean-diverged-branch | behind 13, ahead 1 | A21, A18, A04, A22 |
| 37 | `codex-s22-release-hygiene-2026-06-15` | `codex/s22-release-hygiene-2026-06-15` | clean-diverged-branch | behind 13, ahead 1 | A22, A10 |
