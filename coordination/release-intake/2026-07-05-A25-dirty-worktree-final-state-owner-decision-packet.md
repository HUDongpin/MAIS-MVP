...
Generated: 2026-07-05T11:12:18.198Z
...
| --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | P1 owner-package release gates | A25 git hygiene and release intake | root package has 3030 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `owner-package:a10-tooling-docs-and-report` | P3 owner-package decisions | A10 tooling, docs, and report | root package has 459 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `physical:root-main` | Physical root lifecycle | main | dirty 4737 | reviewed owner package commit; owner-approved exact-path discard; evidence archive with release-source blocker; blocker |
...
```json
{
  ...
  "priority": 3,
  "entries": 459,
  "currentBlocker": "root package has 459 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
