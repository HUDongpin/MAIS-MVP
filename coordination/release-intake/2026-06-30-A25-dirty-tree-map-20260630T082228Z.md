...
Generated at: 2026-06-30T08:22:33.895Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 physical lifecycle decision packet
Status signature: `7a9a1ee71485abeb74d9c3237db7a6d02b87ea97d717f9369819eefa63ee711a`

## Counts

- Collapsed status entries: 1221
- Expanded status entries: 2414
- Tracked modified: 390
- Tracked deleted: 1
- Untracked status entries: 830
- Untracked files: 2023

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 894 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1270 |
