...
Generated: 2026-07-10T17:05:38.573Z
...
| --- | --- | --- | --- | ---: | ---: | ---: | ---: |
| `wave-01-governance-release-hygiene` | `wave-01-governance-release-hygiene` | A25 git hygiene and release intake, A22 production reliability and release engineering, A10 tooling, docs, and report, Manual A10/A25 owner assignment required | blocked | 1012 | 1 | 404 | 0 |
| `wave-02-shared-contracts` | `wave-02-shared-contracts` | A08 state and analytics lead, A12 backend/API platform | blocked | 186 | 4 | 689 | 1 |
...
| `wave-04-practice-lesson-content` | `a18-a21-a23-a24-content-evidence` | A18 curriculum QA / A21 content pipeline, A21 content pipeline and RAG operations, A23 integration and promotion lead, A24 illustration exact-layer | blocked | 222 | 3 | 756 | 110 |
...
- Owners: A25 git hygiene and release intake, A22 production reliability and release engineering, A10 tooling, docs, and report, Manual A10/A25 owner assignment required
- Owner approval IDs: `a25-git-hygiene-and-release-intake`, `a22-production-reliability-and-release-engineering`, `a10-tooling-docs-and-report`, `manual-a10-a25-owner-assignment-required`
- Physical lifecycle approval IDs: `codex-a25-dirty-closure-governance`, `codex-a10-a22-release-governance`, `codex-a22-p1-release-hygiene-security`, `codex-a22-next-15-5-19-audit`, `codex-a22-us-region-alignment`, `codex-a22-missing-module-release-slice`, `codex-a25-ci-backup-workflow`
...
- Status entries: 1012
- Covered / uncovered: 1012 / 0
- Wave01 frontier: post-clean-verified; artifact-clean authorized=0; held=0; valid execution instructions=0
- Wave01 frontier evidence: `coordination/release-intake/latest-A25-wave01-package-resync-owner-authorizations-current-gate.json,coordination/release-intake/latest-A25-wave01-a25-artifact-clean-owner-approval-capsule.json,coordination/release-intake/latest-A25-wave01-artifact-clean-post-clean-verification-plan.json,coordination/release-intake/latest-A25-wave01-package-resync-owner-acceptance-docket.json`
- Failed checks: typeCheck
- Type-check error lines: 404
- Blocking reasons: npm run type-check failed
- Pathspecs:
...
- Required authorization text:
  ...
  - Authorize approvalId=manual-a10-a25-owner-assignment-required for owner=Manual A10/A25 owner assignment required; selectedFinalState=<reviewed commit | owner-approved exact-path discard | evidence archive | blocker>; evidenceReviewed=coordination/release-intake/latest-A25-effective-owner-manual-a10-a25-owner-assignment-required.pathspec, coordination/release-intake/latest-A25-effective-work-order-manual-a10-a25-owner-assignment-required.md; approvedBy=<owner>; approvedAt=<ISO-8601>; notes=<scope and checks>.
...
- Post-approval checks:
  ...
  - `node coordination/release-intake/review-owner-pathspec.mjs coordination/release-intake/latest-A25-effective-owner-manual-a10-a25-owner-assignment-required.pathspec --status`
  - `npm run release:dirty-map -- --reason "A25 post-owner-approval manual-a10-a25-owner-assignment-required"`
...
- Status entries: 186
- Covered / uncovered: 185 / 1
- Wave01 frontier: n/a
- Wave01 frontier evidence: n/a
