...
Generated at: 2026-06-27T18:07:40.887Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-smoke-auth-precheck-report-final-2026-06-28
Status signature: `a0f46b868ecb7041380ddcbf0611d16c8b2925f1007aa31a2996b877697bac3b`

## Counts

- Collapsed status entries: 1088
- Expanded status entries: 1855
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 705
- Untracked files: 1472

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 543 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 885 |
