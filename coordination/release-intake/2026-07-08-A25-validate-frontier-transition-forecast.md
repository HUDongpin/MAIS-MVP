...
Generated: 2026-07-08T12:21:18.498Z
...
- Combined frontier owner rows: 0
- A25 current focus rows: 0
...
- Current pending canonical authorization rows: 39
- Projected pending canonical authorization rows: 39
- Current valid authorization rows: 24
...
| `a22-extraction-recording-and-guarded-extraction` | unlocked-but-not-executed | release-source-clean | 4 | A22 selectedAction owner input only unlocks the recording/extraction chain; candidate mutation dry-run remains dry-run-blocked-owner-candidate-mutation-input with 0 mutation rows. |
...
| `combined-frontier-shape-current` | pass | ownerInputGroups=2; a25Rows=0; a22Rows=0; total=4 |
| `a25-transition-projection-current` | pass | pending=39; projectedPending=39; projectedValid=24 |
