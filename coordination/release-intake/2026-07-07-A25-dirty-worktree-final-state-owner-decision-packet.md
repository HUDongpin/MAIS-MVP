...
Generated: 2026-07-07T15:59:31.241Z
...
- P4 owner-package decisions: 12
- Physical root lifecycle: 1
- Dirty linked worktrees: 29
- Clean-diverged linked branches: 9
...
| --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | P1 owner-package release gates | A25 git hygiene and release intake | root package has 4004 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `owner-package:a10-tooling-docs-and-report` | P3 owner-package decisions | A10 tooling, docs, and report | root package has 476 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `physical:root-main` | Physical root lifecycle | main | dirty 5728 | reviewed owner package commit; owner-approved exact-path discard; evidence archive with release-source blocker; blocker |
...
| `physical:codex-a22-us-region-alignment` | Clean-diverged linked branches | codex/A22-us-region-alignment | behind 2, ahead 1 | owner-approved PR or review package; archive-state record; owner-approved branch or worktree retirement; blocker |
...
```json
{
  ...
  "priority": 3,
  "entries": 476,
  "currentBlocker": "root package has 476 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": null,
  "entries": null,
  "currentBlocker": "behind 2, ahead 1",
  "allowedFinalStates": [
    "owner-approved PR or review package",
    "archive-state record",
    "owner-approved branch or worktree retirement",
