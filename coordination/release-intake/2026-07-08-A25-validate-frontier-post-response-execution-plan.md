...
- Generated at: 2026-07-08T12:21:19.097Z
- Plan status: waiting-for-a22-candidate-mutation-owner-input
...
- Ready for merge: no
- Clean source queue status: waiting-top-candidate-candidate-mutation-owner-input
...
- record-a25-owner-package-authorizations: no-pending-focus-rows; rows=0; executableNow=false
- record-a22-root-parity-owner-input: already-recorded; rows=4; executableNow=false
- record-validation-hold-confirmation: dry-run-ready-requires-explicit-apply; rows=1; executableNow=false
...
- [pass] owner-response-still-waiting: packetStatus=owner-response-consumed-waiting-candidate-mutation-input; frontierOwnerRows=0
- [pass] recorders-fail-closed-until-owner-response: record-a25-owner-package-authorizations=no-pending-focus-rows; record-a22-root-parity-owner-input=already-recorded; record-validation-hold-confirmation=dry-run-ready-requires-explicit-apply
- [pass] post-response-sequence-has-seven-step-coverage: sequenceRows=8
- [pass] validate-to-merge-still-blocked: validateExitReady=false; cleanSourceQueue=waiting-top-candidate-candidate-mutation-owner-input
