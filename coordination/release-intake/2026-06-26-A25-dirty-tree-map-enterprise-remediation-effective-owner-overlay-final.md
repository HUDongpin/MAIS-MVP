...
Generated at: 2026-06-26T10:14:32.030Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 effective owner overlay final inventory
Status signature: `bee1fa4991217253db0e383dbad7fd98f66989b67686ec34edf4e3f6d9f9c78a`

## Counts

- Collapsed status entries: 960
- Expanded status entries: 1486
- Tracked modified: 367
- Tracked deleted: 0
- Untracked status entries: 593
- Untracked files: 1119

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 313 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 611 |
