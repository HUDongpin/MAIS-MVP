...
| --- | --- | --- | --- | --- | --- | --- | --- |
| a12-backend-api-platform | yes | no | no | waiting-for-owner-authorization | canonical row is missing | no | no |
