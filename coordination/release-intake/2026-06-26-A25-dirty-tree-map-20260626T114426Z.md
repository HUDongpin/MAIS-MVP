...
Generated at: 2026-06-26T11:44:28.235Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 pre-production refresh for A22 bug-ui staging deploy to www.mais.hk and www.mais.ac
Status signature: `d15d86f0437efbdada8b64dd274ad79a4dffe6c28f740dcccd0e6a701997d6fd`

## Counts

- Collapsed status entries: 964
- Expanded status entries: 1654
- Tracked modified: 366
- Tracked deleted: 0
- Untracked status entries: 598
- Untracked files: 1288

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 477 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 776 |
