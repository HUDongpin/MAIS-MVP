...
Generated: 2026-07-09T14:10:21.390Z
...
| --- | --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | owner-package | A25 git hygiene and release intake | root package has 4872 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `owner-package:a12-backend-api-platform` | owner-package | A12 backend/API platform | root package has 175 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a11-qa-and-release-quality` | owner-package | A11 QA and release quality | root package has 62 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a10-tooling-docs-and-report` | owner-package | A10 tooling, docs, and report | root package has 482 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a05-lesson-lead` | owner-package | A05 lesson lead | root package has 128 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a21-content-pipeline-and-rag-operations` | owner-package | A21 content pipeline and RAG operations | root package has 74 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a04-practice-lead` | owner-package | A04 practice lead | root package has 59 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `owner-package:a18-curriculum-qa-a21-content-pipeline` | owner-package | A18 curriculum QA / A21 content pipeline | root package has 30 dirty entries | approved-reviewed-commit | reviewed commit |
| `owner-package:a13-teacher-console` | owner-package | A13 teacher console | root package has 36 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `owner-package:a24-illustration-exact-layer` | owner-package | A24 illustration exact-layer | root package has 6 dirty entries | approved-reviewed-commit | reviewed commit |
...
| `physical:root-main` | physical-lifecycle | main | dirty 6604 | approved-reviewed-owner-package-commit | reviewed owner package commit |
...
| `physical:codex-a08-a12-shared-contract-closure` | physical-lifecycle | codex/A08-A12-shared-contract-closure | dirty 185 | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction |
...
| `physical:codex-a22-missing-module-release-slice` | physical-lifecycle | codex/A22-missing-module-release-slice | dirty 1016 | approved-owner-reviewed-commit-or-package-extraction | owner-reviewed commit or package extraction |
...
- Approved at: 2026-07-09T14:10:21.341Z
