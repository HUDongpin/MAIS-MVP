...
Generated at: 2026-06-27T07:51:38.249Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: worked-example illustration inventory before A21/A24/A18 slice
Status signature: `135776ee456346ec32ab34a1406114879d038f158b2860f2ba14d6062b58553b`

## Counts

- Collapsed status entries: 1030
- Expanded status entries: 1747
- Tracked modified: 370
- Tracked deleted: 1
- Untracked status entries: 659
- Untracked files: 1376

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 497 |
| A06 visualization lead | 339 |
| A10 tooling, docs, and report | 166 |
| A12 backend/API platform | 161 |
| A18 curriculum QA / A21 content pipeline | 135 |
| Unmapped runtime owner review needed | 108 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 821 |
| runtime app/API/data/public | 524 |
| tests/regression evidence | 315 |
