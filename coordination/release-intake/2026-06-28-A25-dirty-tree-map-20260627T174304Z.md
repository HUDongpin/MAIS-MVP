...
Generated at: 2026-06-27T17:43:08.645Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-after-scoped-cleanup-2026-06-28
Status signature: `b8a41d0d73fc5f54d7a6672c9435fa78e8af2a84c88e8cd7ea595c4586aab558`

## Counts

- Collapsed status entries: 1081
- Expanded status entries: 1834
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 698
- Untracked files: 1451

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 529 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 871 |
