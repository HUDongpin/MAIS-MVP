...
- Generated at: 2026-07-08T12:21:19.269Z
- Ledger status: waiting-for-a22-candidate-mutation-owner-input
...
- a22:a06-visualization-back-to-top-import-parity: a22-root-parity-selected-action-owner-input; target=`coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json`; status=owner-input-recorded-waiting-candidate-mutation-input; blocker=already-recorded
- a22:a20-math-virus-blaster-data-parity: a22-root-parity-selected-action-owner-input; target=`coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json`; status=owner-input-recorded-waiting-candidate-mutation-input; blocker=already-recorded
- a22:a20-mighty-tank-battle-data-parity: a22-root-parity-selected-action-owner-input; target=`coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json`; status=owner-input-recorded-waiting-candidate-mutation-input; blocker=already-recorded
- a22:a05-california-high-school-lesson-illustration-data-parity: a22-root-parity-selected-action-owner-input; target=`coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json`; status=owner-input-recorded-waiting-candidate-mutation-input; blocker=already-recorded
...
- [pass] post-response-plan-fail-closed: planStatus=waiting-for-a22-candidate-mutation-owner-input; dryRunBlockedRows=3
- [pass] owner-inputs-not-ready-yet: ownerInputsReady=false; pendingCanonicalAuthorizationRows=39
