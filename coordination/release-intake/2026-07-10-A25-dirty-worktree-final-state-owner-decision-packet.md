...
Generated: 2026-07-10T15:56:09.304Z
...
| --- | --- | --- | --- | --- |
| `owner-package:a25-git-hygiene-and-release-intake` | P1 owner-package release gates | A25 git hygiene and release intake | root package has 5287 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `owner-package:a12-backend-api-platform` | P2 owner-package shared/runtime blockers | A12 backend/API platform | root package has 178 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a11-qa-and-release-quality` | P2 owner-package shared/runtime blockers | A11 QA and release quality | root package has 64 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a10-tooling-docs-and-report` | P3 owner-package decisions | A10 tooling, docs, and report | root package has 490 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a05-lesson-lead` | P3 owner-package decisions | A05 lesson lead | root package has 129 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a21-content-pipeline-and-rag-operations` | P3 owner-package decisions | A21 content pipeline and RAG operations | root package has 76 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a04-practice-lead` | P3 owner-package decisions | A04 practice lead | root package has 60 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a18-curriculum-qa-a21-content-pipeline` | P3 owner-package decisions | A18 curriculum QA / A21 content pipeline | root package has 45 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `owner-package:a24-illustration-exact-layer` | P4 owner-package decisions | A24 illustration exact-layer | root package has 168 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
| `owner-package:a13-teacher-console` | P4 owner-package decisions | A13 teacher console | root package has 37 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `owner-package:manual-a10-a25-owner-assignment-required` | P4 owner-package decisions | Manual A10/A25 owner assignment required | root package has 7 dirty entries | reviewed commit; owner-approved exact-path discard; evidence archive; blocker |
...
| `physical:root-main` | Physical root lifecycle | main | dirty 7221 | reviewed owner package commit; owner-approved exact-path discard; evidence archive with release-source blocker; blocker |
...
| `physical:codex-a08-a12-shared-contract-closure` | Dirty linked worktrees | codex/A08-A12-shared-contract-closure | dirty 186 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
| `physical:codex-a22-missing-module-release-slice` | Dirty linked worktrees | codex/A22-missing-module-release-slice | dirty 1017 | owner-reviewed commit or package extraction; owner-approved exact-path discard; evidence archive with retained-worktree blocker; owner-approved worktree removal after dirty state closure; blocker |
...
```json
{
  ...
  "priority": 3,
  "entries": 490,
  "currentBlocker": "root package has 490 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 3,
  "entries": 129,
  "currentBlocker": "root package has 129 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 3,
  "entries": 76,
  "currentBlocker": "root package has 76 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 3,
  "entries": 60,
  "currentBlocker": "root package has 60 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 3,
  "entries": 45,
  "currentBlocker": "root package has 45 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 4,
  "entries": 168,
  "currentBlocker": "root package has 168 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
```json
{
  ...
  "priority": 4,
  "entries": 37,
  "currentBlocker": "root package has 37 dirty entries",
  "allowedFinalStates": [
    "reviewed commit",
    "owner-approved exact-path discard",
    "evidence archive",
...
- Action group: P4 owner-package decisions
- Source kind: owner-package
- Owner or branch: Manual A10/A25 owner assignment required
- Package/lifecycle kind: runtime
- Current blocker: root package has 7 dirty entries
- Evidence to review:
...
```json
{
  "ledgerId": "owner-package:manual-a10-a25-owner-assignment-required",
  "sourceKind": "owner-package",
