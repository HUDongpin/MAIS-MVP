...
Generated at: 2026-06-28T03:49:28.895Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-auth-precheck-order-2026-06-28
Status signature: `bdcbd8b2235b04a5906b469fed9dfebebf22c6a39d78a3e455d21381a975a6e6`

## Counts

- Collapsed status entries: 1097
- Expanded status entries: 1906
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 714
- Untracked files: 1523

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 585 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 931 |
