...
Generated: 2026-07-05T11:15:46.569Z
...
| --- | --- | --- | ---: | ---: | ---: | ---: |
| Canonical next-owner authorizations | `coordination/release-intake/latest-A25-next-owner-authorizations.json` | yes | 71 | 7 | 64 | 0 |
| Next-owner authorization execution preview | `coordination/release-intake/latest-A25-next-owner-authorization-execution-preview-current-gate.json` | yes | 71 | 7 | 71 | 0 |
| Wave 01 package-resync owner authorizations | `coordination/release-intake/latest-A25-wave01-package-resync-owner-authorizations.json` | yes | 7 | 6 | 1 | 0 |
