...
Generated at: 2026-06-27T17:47:52.517Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-final-after-cleanup-log-2026-06-28
Status signature: `ee1d729a68aa014ac70c2070b25b93d1b538f95d4bfb93e830e63017c3f30c41`

## Counts

- Collapsed status entries: 1081
- Expanded status entries: 1838
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 698
- Untracked files: 1455

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 533 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 875 |
