# 2026-07-11 A25 Effective Work Order - A11 QA and release quality
...
node coordination/release-intake/review-owner-pathspec.mjs coordination/release-intake/latest-A25-effective-owner-a11-qa-and-release-quality.pathspec --diffstat
```
...
- `M` `tests/e2e/practice-bank-solvability.spec.ts`
...
- `M` `tests/e2e/production-question-bank-solvability.spec.ts`
