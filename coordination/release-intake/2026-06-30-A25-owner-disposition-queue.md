# 2026-06-30 A25 Owner Disposition Queue

Generated: 2026-06-30T15:48:01.563Z
...
| P1 | A22 production reliability and release engineering | 41 | docs/coordination evidence: 24 | `coordination/release-intake/latest-A25-owner-a22-production-reliability-and-release-engineering.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Release gate and deploy-source hygiene. |
| P2 | A06 visualization lead | 437 | runtime app/API/data/public: 231 | `coordination/release-intake/latest-A25-owner-a06-visualization-lead.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Largest dirty owner package; also linked to dirty visualization worktree. |
...
| P3 | A10 tooling, docs, and report | 215 | docs/coordination evidence: 209 | `coordination/release-intake/latest-A25-owner-a10-tooling-docs-and-report.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Shared coordination/config surface. |
...
| P4 | A02 dashboard lead | 20 | runtime app/API/data/public: 13 | `coordination/release-intake/latest-A25-owner-a02-dashboard-lead.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Standard owner review package. |
...
| P4 | A08 state and analytics lead | 10 | runtime app/API/data/public: 5 | `coordination/release-intake/latest-A25-owner-a08-state-and-analytics-lead.pathspec` | reviewed commit, owner-approved discard, evidence archive, or blocker | Standard owner review package. |
