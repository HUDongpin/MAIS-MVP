...
Generated: 2026-07-07T15:59:35.591Z
...
| --- | --- | --- | --- | --- |
| `physical:root-main` | main | dirty-open-decision | dirty 5728 | Owner packages must be reviewed, committed/extracted, archived, or explicitly discarded before root can become a clean release source. |
