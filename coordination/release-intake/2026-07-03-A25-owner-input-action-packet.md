...
Generated: 2026-07-03T09:41:55.316Z
...
| ---: | --- | --- | ---: | ---: |
| 1 | wave01-package-resync-approvals | Approve, reject, or defer the exact Wave 01 package-resync rows. | 7 | 0 |
| 2 | owner-package-blocker-report-records | Ask each routed owner to either resolve blockers in its recommended worktree or record a concrete blocker report. | 10 | 0 |
| 3 | canonical-final-state-decisions | Select final states for the remaining owner-package and physical-lifecycle rows only after package evidence is reviewed. | 61 | 0 |
| 4 | final-clean-source-verification | Run final A22/A25/A11 release-source checks only after root status, dirty-map zero, and strict lifecycle are green. | 5 | 0 |
...
| --- | --- | --- | ---: | ---: | --- |
| Canonical next-owner authorizations | `coordination/release-intake/latest-A25-next-owner-authorizations.json` | yes | 68 | 68 | canonical authorization input |
...
| --- | --- | --- | ---: | --- | --- | --- | --- |
| A06 | owner-package-blocker-report-a06 | A06 visualization lead | 14 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A06-visualization-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A06-visualization-closure` to resolve the routed blockers inside A06's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a06.md` |
| A13 | owner-package-blocker-report-a13 | A13 teacher console lead | 13 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A13-teacher-console-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A13-teacher-console-closure` to resolve the routed blockers inside A13's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a13.md` |
| A18 | owner-package-blocker-report-a18 | A18 curriculum QA and content quality lead | 4 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A18-content-qa-closure` | `npm run test:analytics` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A18-content-qa-closure` to resolve the routed blockers inside A18's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run test:analytics`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a18.md` |
| A03 | owner-package-blocker-report-a03 | A03 curriculum roadmap lead | 3 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A03-roadmap-closure` | `npm run test:analytics` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A03-roadmap-closure` to resolve the routed blockers inside A03's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run test:analytics`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a03.md` |
| A04 | owner-package-blocker-report-a04 | A04 practice lead | 2 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A04-practice-closure` | `npm run test:analytics` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A04-practice-closure` to resolve the routed blockers inside A04's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run test:analytics`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a04.md` |
| A20 | owner-package-blocker-report-a20 | A20 game design and game-based learning lead | 8 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A17-A20-game-motivation-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A17-A20-game-motivation-closure` to resolve the routed blockers inside A20's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a20.md` |
| A15 | owner-package-blocker-report-a15 | A15 adaptive engine lead | 2 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A15-adaptive-engine-closure` | `npm run test:analytics` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A15-adaptive-engine-closure` to resolve the routed blockers inside A15's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run test:analytics`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a15.md` |
| A11 | owner-package-blocker-report-a11 | A11 QA and release quality lead | 1 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A11-regression-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A11-regression-closure` to resolve the routed blockers inside A11's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a11.md` |
| A12 | owner-package-blocker-report-a12 | A12 backend/API platform lead | 2 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A12-backend-api-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A12-backend-api-closure` to resolve the routed blockers inside A12's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a12.md` |
| A07 | owner-package-blocker-report-a07 | A07 AI tutor lead | 1 | `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A07-ai-tutor-closure` | `npm run type-check -- --pretty false` | Use `/Users/dongpinhu/.config/superpowers/worktrees/MAIS-MVP/A07-ai-tutor-closure` to resolve the routed blockers inside A07's allowed write scope, or copy this draft into the owner blocker records file with reportStatus=recorded-owner-blocker and a concrete blocker summary then rerun `npm run type-check -- --pretty false`. | `coordination/release-intake/latest-A25-pending-owner-blocker-report-a07.md` |
