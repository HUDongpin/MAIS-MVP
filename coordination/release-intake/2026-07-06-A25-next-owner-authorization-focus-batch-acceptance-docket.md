...
Generated: 2026-07-06T15:50:21.890Z
...
| ---: | --- | --- | --- | --- | --- |
| 1 | `a09-copy-i18n-accessibility` | A09 copy, i18n, accessibility | no | no | canonical row is missing |
| 2 | `a17-gamification-and-motivation` | A17 gamification and motivation | no | no | canonical row is missing |
| 3 | `a23-integration-and-promotion-lead` | A23 integration and promotion lead | no | no | canonical row is missing |
