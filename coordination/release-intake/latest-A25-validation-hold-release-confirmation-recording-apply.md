...
Generated: 2026-07-09T09:55:29.567Z

Recorder status: `applied-owner-confirmation-record`

Mode: `apply-recording`

Dirty map signature: `20c7448db61729ea2d5d202df4c84dc83261d5936eb4308df90c8b2227c39fb7`

Expanded dirty entries: 6583
...
- Apply permitted: true
- Mutations performed: true
- Records owner-confirmation rows: 1
...
```json
{
  "recordedAt": "2026-07-09T09:55:29.567Z",
  "recordKind": "a25-validation-hold-release-owner-confirmation-record",
  "dirtyMapStatusSignature": "20c7448db61729ea2d5d202df4c84dc83261d5936eb4308df90c8b2227c39fb7",
  "expandedStatusEntries": 6583,
...
| `owner-confirmation-input-status-coherent` | `pass` | inputFilePresent=true; status=ready-to-apply-recording |
| `owner-confirmation-accepted-or-blocked` | `pass` | confirmationAccepted=true; validationFailures=0 |
| `release-review-ready-or-blocked` | `pass` | releaseReviewReady=true; status=ready-to-apply-recording |
...
| `apply-requires-explicit-recording-flag` | `pass` | mode=apply-recording; status=ready-to-apply-recording |
| `record-status-coherent` | `pass` | status=ready-to-apply-recording |

## Boundary

- Records owner confirmation: true
