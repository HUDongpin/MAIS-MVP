...
Generated: 2026-07-04T15:49:59.373Z
...
| 3 | physical-lifecycle-approvals | 38 | Linked worktrees and diverged branches need explicit lifecycle final-state choices before strict lifecycle can pass. |
...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 2614 | root package has 2614 dirty entries |
...
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 455 | root package has 455 dirty entries |
...
Showing first 12 of 38.

| Approval ID | Branch | State | Current blocker | Owner hints |
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 4323 | A25, A10, A22, effective file owners |
