...
Generated at: 2026-06-30T16:03:13.503Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 settle final-state selection template artifacts
Status signature: `377a74e6b7cca0bfafd7de81045ca8a9066304919781d72895fd9c8736d8a05a`

## Counts

- Collapsed status entries: 1223
- Expanded status entries: 2591
- Tracked modified: 389
- Tracked deleted: 1
- Untracked status entries: 833
- Untracked files: 2201

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 1069 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1447 |
