...
- Executable rows: 0
- Rows with package resync recommendations: 0
- Type-check error lines routed: 9907

| Wave | Package | Package owners | Route to owners | Failed checks | Type errors | Resyncs |
| --- | --- | --- | --- | ---: | ---: | ---: |
| `wave-01-governance-release-hygiene` | `wave-01-governance-release-hygiene` | A25, A22, A10 | A13 (150), A06 (25), A20 (23), A12 (9) | 1 | 404 | 0 |
