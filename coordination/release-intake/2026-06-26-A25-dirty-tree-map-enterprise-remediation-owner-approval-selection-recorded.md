...
Generated at: 2026-06-26T11:12:33.920Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 owner approval selection recorded
Status signature: `db3c04841c14e1a0b1527add894c2b9cae3f04375fcfb11535ddff0e8baa1e06`

## Counts

- Collapsed status entries: 963
- Expanded status entries: 1645
- Tracked modified: 367
- Tracked deleted: 0
- Untracked status entries: 596
- Untracked files: 1278

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 469 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 767 |
