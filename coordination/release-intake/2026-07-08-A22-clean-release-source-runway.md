...
Generated: 2026-07-08T14:15:18.136Z
...
| --- | --- | --- | --- | ---: | --- |
| `current-root-clean-worktree` | clean worktree | blocked | no | 3 | 6130 root dirty status entries remain in integration inventory; dirty-root deploy guard is expected to block direct preview/production publish; A22 policy requires a clean worktree, clean clone, reviewed clean release slice, or owner-approved pruned staging package |
...
| --- | --- | --- | ---: | --- |
| `a22-release-source-not-clean` | A22 production reliability and release engineering | blocked | 6130 | The current root remains a dirty integration inventory and cannot be used as the release source. |
