...
| --- | --- | ---: | ---: | --- |
| `a25-git-hygiene-and-release-intake` | A25 git hygiene and release intake | P1 | 4404 | root package has 4404 dirty entries |
...
| `a10-tooling-docs-and-report` | A10 tooling, docs, and report | P3 | 478 | root package has 478 dirty entries |
...
| --- | --- | --- | --- | --- |
| `root-main` | `main` | dirty-open-decision | dirty 6130 | A25, A10, A22, effective file owners |
