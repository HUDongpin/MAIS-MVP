...
Generated at: 2026-06-27T18:22:39.927Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: dashboard-neon-final-report-refresh-2026-06-28
Status signature: `1ae4d9c2720f76276f60b61af43c8c68356ec648ab9f951cb4058a3ddf634111`

## Counts

- Collapsed status entries: 1091
- Expanded status entries: 1868
- Tracked modified: 382
- Tracked deleted: 1
- Untracked status entries: 708
- Untracked files: 1485

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 553 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 896 |
