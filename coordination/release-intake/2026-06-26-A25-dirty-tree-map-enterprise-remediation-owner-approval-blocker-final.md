...
Generated at: 2026-06-26T11:07:44.526Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 pending owner approval blocker evidence
Status signature: `8c55a609f4ff42e1b227341b9895110a8899d6f996a73e7ceb07d68317f4663c`

## Counts

- Collapsed status entries: 963
- Expanded status entries: 1641
- Tracked modified: 367
- Tracked deleted: 0
- Untracked status entries: 596
- Untracked files: 1274

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 465 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 763 |
