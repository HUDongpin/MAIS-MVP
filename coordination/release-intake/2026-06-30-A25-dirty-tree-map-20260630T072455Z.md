...
Generated at: 2026-06-30T07:25:01.792Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: A25 dirty-worktree implementation blocker handoff
Status signature: `d523910ccdd89f9c5e846c20b04ba0ff30d383d256b163dd548b41286003c8e1`

## Counts

- Collapsed status entries: 1210
- Expanded status entries: 2198
- Tracked modified: 385
- Tracked deleted: 1
- Untracked status entries: 824
- Untracked files: 1812

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 764 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 1138 |
| runtime app/API/data/public | 591 |
