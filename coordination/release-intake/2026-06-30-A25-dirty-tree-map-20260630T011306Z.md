...
Generated at: 2026-06-30T01:13:08.091Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: P1 release hygiene dependency security clean worktree intake
Status signature: `9086c5fe590d2fcf912c2b1970eeca0a7c77f3d7310dc295230f8e095691dd98`

## Counts

- Collapsed status entries: 1205
- Expanded status entries: 2039
- Tracked modified: 384
- Tracked deleted: 1
- Untracked status entries: 820
- Untracked files: 1654

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 609 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 982 |
