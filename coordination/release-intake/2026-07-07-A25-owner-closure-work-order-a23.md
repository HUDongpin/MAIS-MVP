# A25 Owner Closure Work Order - A23
...
| --- | --- | --- | --- | --- | --- |
| a23-integration-and-promotion-lead | owner-package | coordination/release-intake/latest-A25-effective-owner-a23-integration-and-promotion-lead.pathspec | owner-selected-final-state | no | no |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| a23-integration-and-promotion-lead | yes | no | no | waiting-for-owner-authorization | canonical row is missing | no | no |
