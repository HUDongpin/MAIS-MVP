...
Generated at: 2026-06-30T06:46:00.763Z
Agents: A25 git hygiene and release intake; A22 production reliability and release engineering; A10 tooling, docs, and report
Reason: 2026-06-30 A25 dirty worktree remediation plan final verification
Status signature: `a7a3347b9261f8dc8ea277755cbc3716168d73b9ed6608dae7b99369acf1dafa`

## Counts

- Collapsed status entries: 1208
- Expanded status entries: 2049
- Tracked modified: 385
- Tracked deleted: 1
- Untracked status entries: 822
- Untracked files: 1663

## Owner Buckets

| Owner bucket | Dirty entries |
| --- | ---: |
| A25 git hygiene and release intake | 616 |
...
| Slice | Dirty entries |
| --- | ---: |
| docs/coordination evidence | 991 |
