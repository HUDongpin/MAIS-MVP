...
Generated: 2026-07-09T12:41:18.527Z
...
- Preview status: `owner-approved-post-extraction-verified-check-remediation`
...
| `top-validation-queue-waits-owner-input` | pass | queueStatus=fallback-candidate-green-await-clean-source-selection-review; topAction=needs-typecheck-remediation-and-fresh-build-observation |
| `owner-action-packet-waiting` | pass | focusStatus=post-extraction-verified; focusRows=4 |
| `acceptance-docket-waiting` | pass | acceptanceStatus=post-extraction-verified; acceptedRows=4 |
| `owner-input-still-blank` | pass | owner input already records the approved selectedAction rows |
| `preview-rows-complete` | pass | rows=4; selectedActionsAllowed=true; exactTextRows=true |
| `preview-non-executable` | pass | preview rows must not authorize cleanup, execution, merge, deploy, destructive git, or physical lifecycle cleanup |
