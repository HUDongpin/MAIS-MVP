...
Generated: 2026-07-08T12:21:18.392Z
...
- Owner-package focus pending rows: 0
...
- A22 candidate targets missing: 4/4
- A22 candidate-mutation executor status: `dry-run-blocked-owner-candidate-mutation-input`
...
| --- | --- | ---: | ---: | --- | --- |
| `owner-package-canonical-authorization-focus-batch` | no-pending-focus-rows | 0 | 0 | `coordination/release-intake/latest-A25-next-owner-authorizations.json` | canonical-owner-package-authorization |
| `a22-root-parity-selected-actions` | ready-for-guarded-extraction | 0 | 4 | `coordination/release-intake/latest-A22-top-clean-candidate-root-parity-extraction-instruction-owner-input.json` | a22-root-parity-selected-action-owner-input |
...
- Guarded extraction status: `dry-run-ready-requires-explicit-apply`
- Candidate mutation executor status: `dry-run-blocked-owner-candidate-mutation-input`
- Candidate mutation owner input blank: yes
...
| `validate-frontier-visible` | pass | handoffStatus=blocked-before-merge; ownerInputFrontierRows=3 |
| `validate-exit-still-blocked` | pass | validateExitReady=false; directFailedMergeChecks=4 |
| `owner-package-focus-ready-for-owner-review` | pass | previewStatus=no-pending-focus-rows; pendingRows=0 |
| `a22-selected-actions-waiting-for-owner` | pass | acceptanceStatus=ready-for-guarded-extraction; previewStatus=owner-approved-waiting-candidate-mutation; acceptanceRows=4; acceptedRows=4 |
| `a22-owner-input-landing-runway-ready` | pass | runwayStatus=owner-input-recorded-post-runway; patchRows=4; postOwnerInputValidationCommands=8; candidateTargetsMissing=4 |
| `a22-candidate-mutation-dry-run-current` | pass | executorStatus=dry-run-blocked-owner-candidate-mutation-input; recordedInstructions=4; applyPermitted=false; candidateMutationRows=0; gateFailures=0 |
