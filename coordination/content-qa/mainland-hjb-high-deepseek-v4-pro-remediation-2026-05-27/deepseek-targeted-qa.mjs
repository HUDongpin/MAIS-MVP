...
function writeOutputs({ reviews, questions, model, apiUrl, startedAt, finishedAt }) {
  ...
  fs.writeFileSync(
    reportMd,
    `# DeepSeek V4 Pro Targeted Remediation QA Report - Mainland HJB High Questions
...
- This targeted rerun writes only remediation QA artifacts; source data remediation was performed separately and did not edit \`data/questions.ts\`, feature UI, or API routes.
`
  );
}
