...
| pep-primary-p1-u-mc-002 | P1 | primary-rag-v1 | multiple-choice | 20以内数感 | 3 | 3 | 3 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p1-u-mc-003 | P1 | primary-rag-v1 | multiple-choice | 20以内数感 | 1 | 1 | 1 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p1-u-fi-091 | P1 | primary-rag-v1 | fill-in | 图形、位置与整时 | 长方体 | 长方体 | 长方体 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p1-u-fi-092 | P1 | primary-rag-v1 | fill-in | 图形、位置与整时 | 长方体 | 长方体 | 长方体 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p1-u-fi-093 | P1 | primary-rag-v1 | fill-in | 图形、位置与整时 | 正方体 | 正方体 | 正方体 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
...
| pep-primary-p2-u-fi-091 | P2 | primary-rag-v1 | fill-in | 长度、角与观察物体 | 39厘米 | 39厘米 | 39厘米 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p2-u-fi-092 | P2 | primary-rag-v1 | fill-in | 长度、角与观察物体 | 34厘米 | 34厘米 | 34厘米 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p2-u-fi-093 | P2 | primary-rag-v1 | fill-in | 长度、角与观察物体 | 41厘米 | 41厘米 | 41厘米 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
...
| pep-primary-p3-u-mc-002 | P3 | primary-rag-v1 | multiple-choice | 多位数运算与分数初步 | 3/6 | 3/6 | 3/6 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-u-mc-003 | P3 | primary-rag-v1 | multiple-choice | 多位数运算与分数初步 | 4/7 | 4/7 | 4/7 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-u-fi-076 | P3 | primary-rag-v1 | fill-in | 测量、年月日与几何 | 46分钟 | 46分钟 | 46分钟 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-u-fi-077 | P3 | primary-rag-v1 | fill-in | 测量、年月日与几何 | 52分钟 | 52分钟 | 52分钟 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-u-fi-078 | P3 | primary-rag-v1 | fill-in | 测量、年月日与几何 | 18分钟 | 18分钟 | 18分钟 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-l-sa-151 | P3 | primary-rag-v1 | short-answer | 统计表达与综合复习 | 8 | 8 | 8 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-l-sa-152 | P3 | primary-rag-v1 | short-answer | 统计表达与综合复习 | 14 | 14 | 14 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p3-l-sa-153 | P3 | primary-rag-v1 | short-answer | 统计表达与综合复习 | 8 | 8 | 8 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p4-u-mc-001 | P4 | primary-rag-v1 | multiple-choice | 大数认识与三位数乘法 | 957 | 957 | 957 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p4-u-mc-002 | P4 | primary-rag-v1 | multiple-choice | 大数认识与三位数乘法 | 481 | 481 | 481 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
| pep-primary-p4-u-mc-003 | P4 | primary-rag-v1 | multiple-choice | 大数认识与三位数乘法 | 615 | 615 | 615 | pass | pass | pass | none | OK | No blocking action; include in grade/batch/type pass-sample review before external quality claims. |
