...
Status: **normative** for this skill's routing and evidence claims. Repository role names can evolve; read the applicable current repository coordination contract when it is not already loaded or relevant rules have changed.
