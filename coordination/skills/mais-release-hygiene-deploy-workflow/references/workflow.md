...
- If same-SHA route readback or required live behavior is absent, state only the current non-live outcome. Do not name a later live-success enum in the current report, even conditionally; list the missing evidence actions instead.
