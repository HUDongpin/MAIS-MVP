...
description: "Use this skill only for an independent A18 judgment on an immutable MAIS content candidate: mathematical correctness, answer validity, curriculum or grade alignment, ambiguity, bilingual quality, source distance, visual sufficiency, pedagogical suitability, or whether the exact reviewed package may advance to integration review. Do not use it as the primary skill for generating or rewriting content, running RSI or B-prime or C0-prime machine review, estimating natural-population performance, validating a Shadow Manifest or Receipt, performing release engineering, deploying, or proving live behavior; route a newly generated immutable version back to A18 for fresh review."
---
