...
Populate every template field from verified evidence. Do not replace source/baseline/checker bindings, attempt/revision relation, or canonical/fresh/replay comparison with a generic phrase such as “exact bindings complete.” If a required value is absent, keep the handoff blocked and identify that field as the resume gate.
